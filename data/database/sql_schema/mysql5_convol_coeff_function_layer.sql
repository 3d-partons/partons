...
polarization_type_id INTEGER NOT NULL,
hash_sum VARCHAR(40) NOT NULL);
...
CREATE TABLE ddvcs_ccf_kinematic (
ddvcs_ccf_kinematic_id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,
xi DOUBLE NOT NULL,
xi_unit INTEGER NOT NULL,
t DOUBLE NOT NULL,
t_unit INTEGER NOT NULL,
...
MuR2_unit INTEGER NOT NULL,
hash_sum VARCHAR(40) NOT NULL);
CREATE INDEX ddvcs_ccf_kinematic_index ON ddvcs_ccf_kinematic (hash_sum);
...
CREATE TABLE ddvcs_ccf_result (
ddvcs_ccf_result_id INTEGER NOT NULL AUTO_INCREMENT PRIMARY KEY,
gpd_type_id INTEGER NOT NULL,
real_part DOUBLE NOT NULL,
img_part DOUBLE NOT NULL,
ccf_result_id INTEGER NOT NULL);
CREATE INDEX ddvcs_ccf_result_index ON ddvcs_ccf_result (ccf_result_id);
...
SELECT ccfk.dvmp_ccf_kinematic_id, ccfk.xi, ccfk.xi_unit, ccfk.t, ccfk.t_unit, ccfk.Q2, ccfk.Q2_unit, ccfk.MuF2, ccfk.MuF2_unit, ccfk.MuR2, ccfk.MuR2_unit, ccfk.meson_type_id, ccfk.polarization_type_id, ccfk.hash_sum
...
CREATE VIEW ddvcs_ccf_kinematic_view AS
SELECT ccfk.ddvcs_ccf_kinematic_id, ccfk.xi, ccfk.xi_unit, ccfk.t, ccfk.t_unit, ccfk.Q2, ccfk.Q2_unit, ccfk.Q2Prim, ccfk.Q2Prim_unit, ccfk.MuF2, ccfk.MuF2_unit, ccfk.MuR2, ccfk.MuR2_unit, ccfk.hash_sum
FROM ddvcs_ccf_kinematic ccfk 
ORDER BY ccfk.ddvcs_ccf_kinematic_id;
...
CREATE VIEW ddvcs_ccf_result_view AS 
SELECT ccfr.ccf_result_id, ccfr.computation_module_name, ccfr.channel_id, ccfrc.gpd_type_id, ccfrc.real_part, ccfrc.img_part, ccfr.computation_id, ccfr.ccf_kinematic_id
FROM ccf_result ccfr
INNER JOIN ddvcs_ccf_result ccfrc ON ccfr.ccf_result_id = ccfrc.ccf_result_id
ORDER BY ccfr.ccf_result_id;
...
SELECT 	ccfr.computation_id, ccfk.dvmp_ccf_kinematic_id, 
	...
	ccfk.MuF2, ccfk.MuF2_unit,
	ccfk.MuR2, ccfk.MuR2_unit,
	mt.meson_type_short_name, mp.polarization_type_short_name,
	ccfr.ccf_result_id, ccfr.computation_module_name, gt.gpd_type_short_name, 
	ccfrc.real_part, '1' as 'real_part_unit',
	ccfrc.img_part, '1' as 'img_part_unit'
...
INNER JOIN polarization_type mp ON ccfk.polarization_type_id = mp.polarization_type_id
ORDER BY ccfr.ccf_result_id;
...
CREATE VIEW ddvcs_ccf_plot_2d_view AS
SELECT 	ccfr.computation_id, ccfk.ddvcs_ccf_kinematic_id, 
	ccfk.xi, ccfk.xi_unit,
	ccfk.t, ccfk.t_unit,
	ccfk.Q2, ccfk.Q2_unit,
	ccfk.Q2Prim, ccfk.Q2Prim_unit,
	...
	ccfrc.real_part, '1' as 'real_part_unit',
	ccfrc.img_part, '1' as 'img_part_unit'
FROM ddvcs_ccf_result ccfrc
INNER JOIN ccf_result ccfr ON ccfr.ccf_result_id = ccfrc.ccf_result_id
INNER JOIN ddvcs_ccf_kinematic ccfk ON ccfk.ddvcs_ccf_kinematic_id = ccfr.ccf_kinematic_id
INNER JOIN gpd_type gt ON ccfrc.gpd_type_id = gt.gpd_type_id
ORDER BY ccfr.ccf_result_id;
