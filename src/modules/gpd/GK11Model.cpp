...
GK11Model* GK11Model::clone() const {
...
// u quark, valence part
	...
	gpdQuarkFlavorData_u.setValence(
			exp(b0 * m_t)
...
// d quark, valence part
	...
	gpdQuarkFlavorData_d.setValence(
			exp(b0 * m_t)
...
GPDResultData GK11Model::computeHt() {
...
// Ht, charge singlet
	...
	GPD_Ht.addGPDQuarkFlavorData(gpdQuark_u);
	GPD_Ht.addGPDQuarkFlavorData(gpdQuark_d);
	GPD_Ht.addGPDQuarkFlavorData(gpdQuark_s);

	return GPD_Ht;
}

double GK11Model::computeSinglet(const GPDQuarkFlavorData &quark_u,
		const GPDQuarkFlavorData &quark_d, const GPDQuarkFlavorData &quark_s) {
...
GPDResultData GK11Model::computeE() {
...
// Gluons
	...
	GPD_E.setGluon(exp(b0 * m_t) * (c1 * Ei1tab.at(0) + c2 * Ei1tab.at(1)));
...
// u quark, valence part
	...
	gpdQuarkFlavorData_u.setValence(
			exp(b0 * m_t) * (c1 * Euval1tab.at(0) + c2 * Euval1tab.at(1)));
...
// EsSinglet = 2. * Es;
	...
	GPD_E.addGPDQuarkFlavorData(gpdQuarkFlavorData_u);
	GPD_E.addGPDQuarkFlavorData(gpdQuarkFlavorData_d);
	GPD_E.addGPDQuarkFlavorData(gpdQuarkFlavorData_s);

	return GPD_E;
}

GPDResultData GK11Model::computeEt() {
...
// u quark, valence part
	...
	fEtuVal += PionPolePx;
	gpdQuarkFlavorData_u.setValence(fEtuVal);
...
// d quark, valence part
	...
	fEtdVal -= PionPolePx;
	gpdQuarkFlavorData_d.setValence(fEtdVal);
...
// u and d quark, sea part
	gpdQuarkFlavorData_u.setSea(0.);
	gpdQuarkFlavorData_d.setSea(0.);
...
// EtsSinglet = 0.;
	...
	GPD_Et.addGPDQuarkFlavorData(gpdQuarkFlavorData_u);
	GPD_Et.addGPDQuarkFlavorData(gpdQuarkFlavorData_d);
	GPD_Et.addGPDQuarkFlavorData(gpdQuarkFlavorData_s);
...
double GK11Model::Hs1(double x, double i, double k) {
...
double GK11Model::Hi1(double x, double i, double k) {
...
double GK11Model::Hs1_alt(double x, double i, double k) {
...
double GK11Model::Hi1_alt(double x, double i, double k) {
	cln::cl_R ia, ka, xba, xia;
	cln::cl_R dummya, dummy1, dummy2, dummy3;
...
double GK11Model::Hval1(double x, double i, double k) {
...
double GK11Model::Hval1_alt(double x, double i, double k) {
	cln::cl_R ia, ka, xba, xia;
 ...
 *
 */
void GK11Model::calculateHtCoefs() {
	int slow_sea = 0; // by default,  fast
	int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
double GK11Model::Htval1_alt(double x, double i, double k) {
 ...
 *
 */
double GK11Model::Hti1(double x, double i, double k) {
 ...
 *
 */
double GK11Model::Hti1_alt(double x, double i, double k) {
 ...
 *
 */
double GK11Model::Htval1(double x, double i, double k) {
 ...
 *
 */
void GK11Model::calculateECoefs() {
	int slow_sea = 0; // by default,  fast
	int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
double GK11Model::Es1(double x, double i, double k) {
	return Hs1(x, i, k);
}
 ...
 *
 */
double GK11Model::Ei1(double x, double i, double k) {
	return Hi1(x, i, k);
}
 ...
 *
 */
double GK11Model::Es1_alt(double x, double i, double k) {
 ...
 *
 */
double GK11Model::Ei1_alt(double x, double i, double k) {
 ...
 *
 */
double GK11Model::Eval1(double x, double i, double k) {
	return Hval1(x, i, k);
}
 ...
 *
 */
double GK11Model::Eval1_alt(double x, double i, double k) {
	return Hval1_alt(x, i, k);
}
 ...
 *
 */
void GK11Model::calculateEtCoefs() {
	int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
double GK11Model::Et_pole(double x) {
 ...
 *
 */
double GK11Model::Etval1(double x, double i, double k) {
	double dum;
 ...
 *
 */
double GK11Model::Etval1_alt(double x, double i, double k) {
	return Hval1_alt(x, i, k);
}

double GK11Model::getB0() const {
	return b0;
}

double GK11Model::getC1() const {
	return c1;
}

double GK11Model::getC2() const {
	return c2;
}

double GK11Model::getC3() const {
	return c3;
}

double GK11Model::getC4() const {
	return c4;
}

double GK11Model::getC5() const {
	return c5;
}

double GK11Model::getC6() const {
	return c6;
}

double GK11Model::getC7() const {
	return c7;
}

double GK11Model::getC8() const {
	return c8;
}

const std::vector<double>& GK11Model::getEdval1mtab() const {
	return Edval1mtab;
}

const std::vector<double>& GK11Model::getEdval1tab() const {
	return Edval1tab;
}

const std::vector<double>& GK11Model::getEi1tab() const {
	return Ei1tab;
}

const std::vector<double>& GK11Model::getEs1tab() const {
	return Es1tab;
}

const std::vector<double>& GK11Model::getEtdval1mtab() const {
	return Etdval1mtab;
}

const std::vector<double>& GK11Model::getEtdval1tab() const {
	return Etdval1tab;
}

const std::vector<double>& GK11Model::getEtuval1mtab() const {
	return Etuval1mtab;
}

const std::vector<double>& GK11Model::getEtuval1tab() const {
	return Etuval1tab;
}

const std::vector<double>& GK11Model::getEuval1mtab() const {
	return Euval1mtab;
}

const std::vector<double>& GK11Model::getEuval1tab() const {
	return Euval1tab;
}

double GK11Model::getEdValMx() const {
	return fEdValMx;
}

double GK11Model::getEtdValMx() const {
	return fEtdValMx;
}

double GK11Model::getEtuValMx() const {
	return fEtuValMx;
}

double GK11Model::getEuValMx() const {
	return fEuValMx;
}

double GK11Model::getHdValMx() const {
	return fHdValMx;
}

double GK11Model::getHtdValMx() const {
	return fHtdValMx;
}

double GK11Model::getHtuValMx() const {
	return fHtuValMx;
}

double GK11Model::getHuValMx() const {
	return fHuValMx;
}
...
const std::vector<double>& GK11Model::getHdval1tab() const {
	return Hdval1tab;
}

const std::vector<double>& GK11Model::getHi1tab() const {
	return Hi1tab;
}

const std::vector<double>& GK11Model::getHs1tab() const {
	return Hs1tab;
}

const std::vector<double>& GK11Model::getHtdval1mtab() const {
	return Htdval1mtab;
}

const std::vector<double>& GK11Model::getHtdval1tab() const {
	return Htdval1tab;
}

const std::vector<double>& GK11Model::getHti1tab() const {
	return Hti1tab;
}

const std::vector<double>& GK11Model::getHtuval1mtab() const {
	return Htuval1mtab;
}

const std::vector<double>& GK11Model::getHtuval1tab() const {
	return Htuval1tab;
}

const std::vector<double>& GK11Model::getHuval1mtab() const {
	return Huval1mtab;
}

const std::vector<double>& GK11Model::getHuval1tab() const {
	return Huval1tab;
}

double GK11Model::getKappaS() const {
	return kappa_s;
}

double GK11Model::getEdval() const {
	return kEdval;
}

double GK11Model::getEgluon() const {
	return kEgluon;
}

double GK11Model::getEsea() const {
	return kEsea;
}

double GK11Model::getEtdval() const {
	return kEtdval;
}

double GK11Model::getEtgluon() const {
	return kEtgluon;
}

double GK11Model::getEtsea() const {
	return kEtsea;
}

double GK11Model::getEtuval() const {
	return kEtuval;
}

double GK11Model::getEuval() const {
	return kEuval;
}

double GK11Model::getHdval() const {
	return kHdval;
}

double GK11Model::getHgluon() const {
	return kHgluon;
}

double GK11Model::getHsea() const {
	return kHsea;
}

double GK11Model::getHtdval() const {
	return kHtdval;
}

double GK11Model::getHtgluon() const {
	return kHtgluon;
}

double GK11Model::getHtsea() const {
	return kHtsea;
}

double GK11Model::getHtuval() const {
	return kHtuval;
}
