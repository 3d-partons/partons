...
private:
    ...
    double convolNonSingletKernel(unsigned int const ix, double const xi, int const n,
    		double const * const gpd, double const * const x);
    double convolSingletqqKernel(unsigned int const ix, double const xi, int const n,
    		double const * const gpd, double const * const x);
    double convolSingletggKernel(unsigned int const ix, double const xi, int const n,
    		double const * const gpd, double const * const x);
    double convolSingletgqKernel(unsigned int const ix, double const xi, int const n,
    		double const * const gpd, double const * const x);
    double convolSingletqgKernel(unsigned int const ix, double const xi, int const n,
    		double const * const gpd, double const * const x);
