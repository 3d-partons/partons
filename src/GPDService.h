...
public:
    ...
    GPDOutputData* compute(GPDInputData* _pGPDInputData, GPDModule* _pGPDModule,
            GPDComputeType::Type _gpdComputeType);

    GPDOutputData* compute(GPDInputData* _pGPDInputData,
            GPDModule* _pGPDModule);

    ListGPDOutputData compute(GPDInputData* _pGPDInputData,
