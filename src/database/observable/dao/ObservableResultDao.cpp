...
int ObservableResultDao::insert(const std::string& observableName,
    ...
    query.prepare(
            "INSERT INTO observable_result (observable_name, observable_value, stat_error_lb, stat_error_ub, syst_error_lb, syst_error_ub, total_error, computation_module_name, observable_kinematic_id, computation_id)  VALUES (:observable_name, :observable_value, :stat_error_lb, :stat_error_ub, :syst_error_lb, :syst_error_ub, :total_error, :computationModuleName, :observable_kinematic_id, :computation_id)");
