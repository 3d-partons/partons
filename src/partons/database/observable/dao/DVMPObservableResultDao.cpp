#include "../../../../../include/partons/database/observable/dao/DVMPObservableResultDao.h"
...
DVMPObservableResultDao::DVMPObservableResultDao() :
        BaseObject("DVMPObservableResultDao") {
}

DVMPObservableResultDao::~DVMPObservableResultDao() {
}

int DVMPObservableResultDao::insert(const std::string& observableName,
    ...
    names.push_back("dvmp_observable_kinematic_id");
    ...
    values.push_back(":dvmp_observable_kinematic_id");
    values.push_back(":computation_id");

    ElemUtils::Formatter formatter;
    formatter << "INSERT INTO " << "dvmp_observable_result"
...
List<DVMPObservableResult> DVMPObservableResultDao::getObservableResultListByComputationId(
        const int computationId) const {
    ...
    //prepare query
    query.prepare(
            "SELECT * FROM dvmp_observable_result WHERE computation_id = :computationId;");
...
void DVMPObservableResultDao::fillObservableResultList(
        List<DVMPObservableResult> &observableResultList,
        QSqlQuery& query) const {

    //get indices
    int field_id = query.record().indexOf("dvmp_observable_result_id");
    ...
    while (query.next()) {
        ...
        DVMPObservableResult observableResult;
        ...
        observableResult.setKinematic(
                m_dvmpObservableKinematicDao.getKinematicById(
...
List<DVMPObservableResult> DVMPObservableResultDao::getObservableResultListFromSQLQuery(
