#include "../../../../../../include/partons/utils/test/report/observable/ObservableResultReport.h"
...
std::string ObservableResultReport::toString() const {
    ...
    if (isSameObservable()) {
        ...
        os
                << "This comparison doesn't make sense since the two observables are different!"
                << std::endl;
    }
