#include "../../../../include/partons/modules/gpd/GK16ModelTest.h"
...
const unsigned int GK16ModelTest::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new GK16ModelTest("GK16ModelTest"));

//TODO initialise missing members
GK16ModelTest::GK16ModelTest(const std::string &className) :
        GPDModule(className) {
    m_nf = 3;
    fL = 0.;
    m_MuF2_ref = 4.;
...
GK16ModelTest::GK16ModelTest(const GK16ModelTest& other) :
        GPDModule(other) {
    c1 = other.getC1();
    c2 = other.getC2();
    c3 = other.getC3();
...
GK16ModelTest* GK16ModelTest::clone() const {
    return new GK16ModelTest(*this);
}

GK16ModelTest::~GK16ModelTest() {
}

void GK16ModelTest::configure(const ElemUtils::Parameters &parameters) {
    GPDModule::configure(parameters);
}

//TODO implement
void GK16ModelTest::isModuleWellConfigured() {
    GPDModule::isModuleWellConfigured();

}

void GK16ModelTest::initModule() {
...
PartonDistribution GK16ModelTest::computeH() {
...
// s quark
    ...
    if (exp(b0 * m_t)
            * (c1 * Hs1tab.at(0) + c2 * Hs1tab.at(1) + c3 * Hs1tab.at(2)
                    + c4 * Hs1tab.at(3)) > 10e-8) {
        quarkDistribution_s.setQuarkDistribution(
                exp(b0 * m_t)
                        * (c1 * Hs1tab.at(0) + c2 * Hs1tab.at(1)
                                + c3 * Hs1tab.at(2) + c4 * Hs1tab.at(3))); // See eq. (27)
    }
...
PartonDistribution GK16ModelTest::computeHt() {
...
PartonDistribution GK16ModelTest::computeE() {
    PartonDistribution partonDistribution;
...
PartonDistribution GK16ModelTest::computeEt() {
    PartonDistribution partonDistribution;
...
//double GK16ModelTest::computeSinglet(const QuarkDistribution &quarkDistribution_u,
...
void GK16ModelTest::calculateHCoefs() {
...
void GK16ModelTest::calculateHKas() {
    double alpha, delta;
...
double GK16ModelTest::Hs1(double x, double i, double k) {
...
double GK16ModelTest::Hi1(double x, double i, double k) {
...
double GK16ModelTest::Hs1_alt(double x, double i, double k) {
...
double GK16ModelTest::Hi1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
    cln::cl_R dummya, dummy1, dummy2, dummy3;
...
double GK16ModelTest::Hval1(double x, double i, double k) {
...
double GK16ModelTest::Hval1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
...
/** !
 *  \fn void STGK16ModelTest::calculateHtCoefs()
 *
...
/*!
 * \fn void STGK16ModelTest::calculateHtKas()
 *
 * Compute t-dependence of GPD Ht correlated to x.
 *
 */
void GK16ModelTest::calculateHtKas() {
    double alpha, delta;
...
/*!
 * \fn void STGK16ModelTest::CalculateEtKas()
 *
 * Exactly the same as Hval1_alt and Eval1_alt.
 *
 */
double GK16ModelTest::Htval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

/*!
 * \fn double STGK16ModelTest::Hti1( double x, double i, double k )
 *
 * Exactly the same as Hs1.
 *
 */
double GK16ModelTest::Hti1(double x, double i, double k) {
 ...
 *
 */
double GK16ModelTest::Hti1_alt(double x, double i, double k) {
 ...
 *
 */
double GK16ModelTest::Htval1(double x, double i, double k) {

    return Hval1(x, i, k);
}

/** !
 *  \fn void STGK16ModelTest::calculateECoefs()
 *
 * Generic function for fast calculation.
 *
 * Calculates :
 ...
 *
 */
void GK16ModelTest::calculateECoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
...
/*!
 * \fn void STGK16ModelTest::calculateEKas()
 *
 * Compute t-dependence of GPD H correlated to x.
 *
 */
void GK16ModelTest::calculateEKas() {
    double alpha, delta;
...
/*!
 * \fn double STGK16ModelTest::Es1( double x, double i, double k )
 *
 * Exactly the same as Hs1.
 *
 */
double GK16ModelTest::Es1(double x, double i, double k) {
    return Hs1(x, i, k);
}

/*!
 * \fn double STGK16ModelTest::Ei1( double x, double i, double k )
 *
 * Exactly the same as Hi1.
 *
 */
double GK16ModelTest::Ei1(double x, double i, double k) {
    return Hi1(x, i, k);
}

/*!
 * \fn double STGK16ModelTest::Es1_alt( double x, double i, double k )
 *
 * Exactly the same as Hs1_alt.
 *
 */
double GK16ModelTest::Es1_alt(double x, double i, double k) {
    return Hs1_alt(x, i, k);
}

/*!
 * \fn double STGK16ModelTest::Ei1_alt( double x, double i, double k )
 *
 * Exactly the same as Hi1_alt.
 *
 */
double GK16ModelTest::Ei1_alt(double x, double i, double k) {
    return Hi1_alt(x, i, k);
}

/*!
 * \fn double STGK16ModelTest::Eval1( double x, double i, double k )
 *
 * Exactly the same as Hval1.
 *
 */
double GK16ModelTest::Eval1(double x, double i, double k) {
    return Hval1(x, i, k);
}
 ...
 *
 */
double GK16ModelTest::Eval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

/** !
 *  \fn void STGK16ModelTest::calculateEtCoefs()
 *
 * Generic function for fast calculation.
 *
 * Calculates :
 ...
 *
 */
void GK16ModelTest::calculateEtCoefs() {
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
void GK16ModelTest::calculateEtKas() {
    double alpha, delta;
...
/* !
 *  \fn double STGK16ModelTest::Et_pole( double x )
 *
 *  Pion pole contribution to Et.
 *
 */
double GK16ModelTest::Et_pole(double x) {
...
/*!
 * \fn double STGK16ModelTest::Etval1( double x, double i, double k )
 *
 ...
 *
 */
double GK16ModelTest::Etval1(double x, double i, double k) {
    double dum;
...
/*!
 * \fn double STGK16ModelTest::Etval1_alt( double x, double i, double k )
 *
 * Exactly the same as Hval1_alt and Eval1_alt, Htval1_alt.
 *
 */
double GK16ModelTest::Etval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

double GK16ModelTest::getB0() const {
    return b0;
}

double GK16ModelTest::getC1() const {
    return c1;
}

double GK16ModelTest::getC2() const {
    return c2;
}

double GK16ModelTest::getC3() const {
    return c3;
}

double GK16ModelTest::getC4() const {
    return c4;
}

double GK16ModelTest::getC5() const {
    return c5;
}

double GK16ModelTest::getC6() const {
    return c6;
}

double GK16ModelTest::getC7() const {
    return c7;
}

double GK16ModelTest::getC8() const {
    return c8;
}

const std::vector<double>& GK16ModelTest::getEdval1mtab() const {
    return Edval1mtab;
}

const std::vector<double>& GK16ModelTest::getEdval1tab() const {
    return Edval1tab;
}

const std::vector<double>& GK16ModelTest::getEi1tab() const {
    return Ei1tab;
}

const std::vector<double>& GK16ModelTest::getEs1tab() const {
    return Es1tab;
}

const std::vector<double>& GK16ModelTest::getEtdval1mtab() const {
    return Etdval1mtab;
}

const std::vector<double>& GK16ModelTest::getEtdval1tab() const {
    return Etdval1tab;
}

const std::vector<double>& GK16ModelTest::getEtuval1mtab() const {
    return Etuval1mtab;
}

const std::vector<double>& GK16ModelTest::getEtuval1tab() const {
    return Etuval1tab;
}

const std::vector<double>& GK16ModelTest::getEuval1mtab() const {
    return Euval1mtab;
}

const std::vector<double>& GK16ModelTest::getEuval1tab() const {
    return Euval1tab;
}

double GK16ModelTest::getEdValMx() const {
    return fEdValMx;
}

double GK16ModelTest::getEtdValMx() const {
    return fEtdValMx;
}

double GK16ModelTest::getEtuValMx() const {
    return fEtuValMx;
}

double GK16ModelTest::getEuValMx() const {
    return fEuValMx;
}

double GK16ModelTest::getHdValMx() const {
    return fHdValMx;
}

double GK16ModelTest::getHtdValMx() const {
    return fHtdValMx;
}

double GK16ModelTest::getHtuValMx() const {
    return fHtuValMx;
}

double GK16ModelTest::getHuValMx() const {
    return fHuValMx;
}

double GK16ModelTest::getL() const {
    return fL;
}

const std::vector<double>& GK16ModelTest::getHdval1mtab() const {
    return Hdval1mtab;
}

const std::vector<double>& GK16ModelTest::getHdval1tab() const {
    return Hdval1tab;
}

const std::vector<double>& GK16ModelTest::getHi1tab() const {
    return Hi1tab;
}

const std::vector<double>& GK16ModelTest::getHs1tab() const {
    return Hs1tab;
}

const std::vector<double>& GK16ModelTest::getHtdval1mtab() const {
    return Htdval1mtab;
}

const std::vector<double>& GK16ModelTest::getHtdval1tab() const {
    return Htdval1tab;
}

const std::vector<double>& GK16ModelTest::getHti1tab() const {
    return Hti1tab;
}

const std::vector<double>& GK16ModelTest::getHtuval1mtab() const {
    return Htuval1mtab;
}

const std::vector<double>& GK16ModelTest::getHtuval1tab() const {
    return Htuval1tab;
}

const std::vector<double>& GK16ModelTest::getHuval1mtab() const {
    return Huval1mtab;
}

const std::vector<double>& GK16ModelTest::getHuval1tab() const {
    return Huval1tab;
}

double GK16ModelTest::getKappaS() const {
    return kappa_s;
}

double GK16ModelTest::getEdval() const {
    return kEdval;
}

double GK16ModelTest::getEgluon() const {
    return kEgluon;
}

double GK16ModelTest::getEsea() const {
    return kEsea;
}

double GK16ModelTest::getEtdval() const {
    return kEtdval;
}

double GK16ModelTest::getEtgluon() const {
    return kEtgluon;
}

double GK16ModelTest::getEtsea() const {
    return kEtsea;
}

double GK16ModelTest::getEtuval() const {
    return kEtuval;
}

double GK16ModelTest::getEuval() const {
    return kEuval;
}

double GK16ModelTest::getHdval() const {
    return kHdval;
}

double GK16ModelTest::getHgluon() const {
    return kHgluon;
}

double GK16ModelTest::getHsea() const {
    return kHsea;
}

double GK16ModelTest::getHtdval() const {
    return kHtdval;
}

double GK16ModelTest::getHtgluon() const {
    return kHtgluon;
}

double GK16ModelTest::getHtsea() const {
    return kHtsea;
}

double GK16ModelTest::getHtuval() const {
    return kHtuval;
}

double GK16ModelTest::getHuval() const {
    return kHuval;
}
