#include "../../../../include/partons/modules/gpd/GK11ModelOnlyGluons.h"
...
const unsigned int GK11ModelOnlyGluons::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new GK11ModelOnlyGluons("GK11ModelOnlyGluonsOnlyGluons"));
...
GK11ModelOnlyGluons::GK11ModelOnlyGluons(const GK11ModelOnlyGluons& other) :
        GPDModule(other) {
    c1 = other.getC1();
    c2 = other.getC2();
    c3 = other.getC3();
...
GK11ModelOnlyGluons* GK11ModelOnlyGluons::clone() const {
    return new GK11ModelOnlyGluons(*this);
}

GK11ModelOnlyGluons::~GK11ModelOnlyGluons() {
}

void GK11ModelOnlyGluons::configure(const ElemUtils::Parameters &parameters) {
    GPDModule::configure(parameters);
}

//TODO implement
void GK11ModelOnlyGluons::isModuleWellConfigured() {
    GPDModule::isModuleWellConfigured();

}

void GK11ModelOnlyGluons::initModule() {
...
PartonDistribution GK11ModelOnlyGluons::computeH() {
...
PartonDistribution GK11ModelOnlyGluons::computeHt() {
...
PartonDistribution GK11ModelOnlyGluons::computeE() {
    PartonDistribution partonDistribution;
...
PartonDistribution GK11ModelOnlyGluons::computeEt() {
    PartonDistribution partonDistribution;
...
//double GK11ModelOnlyGluons::computeSinglet(const QuarkDistribution &quarkDistribution_u,
...
void GK11ModelOnlyGluons::calculateHCoefs() {
...
void GK11ModelOnlyGluons::calculateHKas() {
    double alpha, delta;
...
double GK11ModelOnlyGluons::Hs1(double x, double i, double k) {
...
double GK11ModelOnlyGluons::Hi1(double x, double i, double k) {
...
double GK11ModelOnlyGluons::Hs1_alt(double x, double i, double k) {
...
double GK11ModelOnlyGluons::Hi1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
    cln::cl_R dummya, dummy1, dummy2, dummy3;
...
double GK11ModelOnlyGluons::Hval1(double x, double i, double k) {
...
double GK11ModelOnlyGluons::Hval1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
...
/** !
 *  \fn void STGK11ModelOnlyGluons::calculateHtCoefs()
 *
 ...
 *
 */
void GK11ModelOnlyGluons::calculateHtCoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
...
/*!
 * \fn void STGK11ModelOnlyGluons::calculateHtKas()
 *
 * Compute t-dependence of GPD Ht correlated to x.
 *
 */
void GK11ModelOnlyGluons::calculateHtKas() {
    double alpha, delta;
...
/*!
 * \fn void STGK11ModelOnlyGluons::CalculateEtKas()
 *
 * Exactly the same as Hval1_alt and Eval1_alt.
 *
 */
double GK11ModelOnlyGluons::Htval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

/*!
 * \fn double STGK11ModelOnlyGluons::Hti1( double x, double i, double k )
 *
 * Exactly the same as Hs1.
 *
 */
double GK11ModelOnlyGluons::Hti1(double x, double i, double k) {
 ...
 *
 */
double GK11ModelOnlyGluons::Hti1_alt(double x, double i, double k) {
 ...
 *
 */
double GK11ModelOnlyGluons::Htval1(double x, double i, double k) {

    return Hval1(x, i, k);
}

/** !
 *  \fn void STGK11ModelOnlyGluons::calculateECoefs()
 *
 * Generic function for fast calculation.
 *
 * Calculates :
 ...
 *
 */
void GK11ModelOnlyGluons::calculateECoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
...
/*!
 * \fn void STGK11ModelOnlyGluons::calculateEKas()
 *
 * Compute t-dependence of GPD H correlated to x.
 *
 */
void GK11ModelOnlyGluons::calculateEKas() {
    double alpha, delta;
...
/*!
 * \fn double STGK11ModelOnlyGluons::Es1( double x, double i, double k )
 *
 * Exactly the same as Hs1.
 *
 */
double GK11ModelOnlyGluons::Es1(double x, double i, double k) {
    return Hs1(x, i, k);
}

/*!
 * \fn double STGK11ModelOnlyGluons::Ei1( double x, double i, double k )
 *
 * Exactly the same as Hi1.
 *
 */
double GK11ModelOnlyGluons::Ei1(double x, double i, double k) {
    return Hi1(x, i, k);
}

/*!
 * \fn double STGK11ModelOnlyGluons::Es1_alt( double x, double i, double k )
 *
 * Exactly the same as Hs1_alt.
 *
 */
double GK11ModelOnlyGluons::Es1_alt(double x, double i, double k) {
    return Hs1_alt(x, i, k);
}

/*!
 * \fn double STGK11ModelOnlyGluons::Ei1_alt( double x, double i, double k )
 *
 * Exactly the same as Hi1_alt.
 *
 */
double GK11ModelOnlyGluons::Ei1_alt(double x, double i, double k) {
    return Hi1_alt(x, i, k);
}

/*!
 * \fn double STGK11ModelOnlyGluons::Eval1( double x, double i, double k )
 *
 * Exactly the same as Hval1.
 *
 */
double GK11ModelOnlyGluons::Eval1(double x, double i, double k) {
    return Hval1(x, i, k);
}
 ...
 *
 */
double GK11ModelOnlyGluons::Eval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

/** !
 *  \fn void STGK11ModelOnlyGluons::calculateEtCoefs()
 *
 * Generic function for fast calculation.
 *
 * Calculates :
 ...
 *
 */
void GK11ModelOnlyGluons::calculateEtCoefs() {
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
void GK11ModelOnlyGluons::calculateEtKas() {
    double alpha, delta;
...
/* !
 *  \fn double STGK11ModelOnlyGluons::Et_pole( double x )
 *
 *  Pion pole contribution to Et.
 *
 */
double GK11ModelOnlyGluons::Et_pole(double x) {
...
/*!
 * \fn double STGK11ModelOnlyGluons::Etval1( double x, double i, double k )
 *
 ...
 *
 */
double GK11ModelOnlyGluons::Etval1(double x, double i, double k) {
    double dum;
...
/*!
 * \fn double STGK11ModelOnlyGluons::Etval1_alt( double x, double i, double k )
 *
 * Exactly the same as Hval1_alt and Eval1_alt, Htval1_alt.
 *
 */
double GK11ModelOnlyGluons::Etval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

double GK11ModelOnlyGluons::getB0() const {
    return b0;
}

double GK11ModelOnlyGluons::getC1() const {
    return c1;
}

double GK11ModelOnlyGluons::getC2() const {
    return c2;
}

double GK11ModelOnlyGluons::getC3() const {
    return c3;
}

double GK11ModelOnlyGluons::getC4() const {
    return c4;
}

double GK11ModelOnlyGluons::getC5() const {
    return c5;
}

double GK11ModelOnlyGluons::getC6() const {
    return c6;
}

double GK11ModelOnlyGluons::getC7() const {
    return c7;
}

double GK11ModelOnlyGluons::getC8() const {
    return c8;
}

const std::vector<double>& GK11ModelOnlyGluons::getEdval1mtab() const {
    return Edval1mtab;
}

const std::vector<double>& GK11ModelOnlyGluons::getEdval1tab() const {
    return Edval1tab;
}

const std::vector<double>& GK11ModelOnlyGluons::getEi1tab() const {
    return Ei1tab;
}

const std::vector<double>& GK11ModelOnlyGluons::getEs1tab() const {
    return Es1tab;
}

const std::vector<double>& GK11ModelOnlyGluons::getEtdval1mtab() const {
    return Etdval1mtab;
}

const std::vector<double>& GK11ModelOnlyGluons::getEtdval1tab() const {
    return Etdval1tab;
}

const std::vector<double>& GK11ModelOnlyGluons::getEtuval1mtab() const {
    return Etuval1mtab;
}

const std::vector<double>& GK11ModelOnlyGluons::getEtuval1tab() const {
    return Etuval1tab;
}

const std::vector<double>& GK11ModelOnlyGluons::getEuval1mtab() const {
    return Euval1mtab;
}

const std::vector<double>& GK11ModelOnlyGluons::getEuval1tab() const {
    return Euval1tab;
}

double GK11ModelOnlyGluons::getEdValMx() const {
    return fEdValMx;
}

double GK11ModelOnlyGluons::getEtdValMx() const {
    return fEtdValMx;
}

double GK11ModelOnlyGluons::getEtuValMx() const {
    return fEtuValMx;
}

double GK11ModelOnlyGluons::getEuValMx() const {
    return fEuValMx;
}

double GK11ModelOnlyGluons::getHdValMx() const {
    return fHdValMx;
}

double GK11ModelOnlyGluons::getHtdValMx() const {
    return fHtdValMx;
}

double GK11ModelOnlyGluons::getHtuValMx() const {
    return fHtuValMx;
}

double GK11ModelOnlyGluons::getHuValMx() const {
    return fHuValMx;
}

double GK11ModelOnlyGluons::getL() const {
    return fL;
}

const std::vector<double>& GK11ModelOnlyGluons::getHdval1mtab() const {
    return Hdval1mtab;
}

const std::vector<double>& GK11ModelOnlyGluons::getHdval1tab() const {
    return Hdval1tab;
}

const std::vector<double>& GK11ModelOnlyGluons::getHi1tab() const {
    return Hi1tab;
}

const std::vector<double>& GK11ModelOnlyGluons::getHs1tab() const {
    return Hs1tab;
}

const std::vector<double>& GK11ModelOnlyGluons::getHtdval1mtab() const {
    return Htdval1mtab;
}

const std::vector<double>& GK11ModelOnlyGluons::getHtdval1tab() const {
    return Htdval1tab;
}

const std::vector<double>& GK11ModelOnlyGluons::getHti1tab() const {
    return Hti1tab;
}

const std::vector<double>& GK11ModelOnlyGluons::getHtuval1mtab() const {
    return Htuval1mtab;
}

const std::vector<double>& GK11ModelOnlyGluons::getHtuval1tab() const {
    return Htuval1tab;
}

const std::vector<double>& GK11ModelOnlyGluons::getHuval1mtab() const {
    return Huval1mtab;
}

const std::vector<double>& GK11ModelOnlyGluons::getHuval1tab() const {
    return Huval1tab;
}

double GK11ModelOnlyGluons::getKappaS() const {
    return kappa_s;
}

double GK11ModelOnlyGluons::getEdval() const {
    return kEdval;
}

double GK11ModelOnlyGluons::getEgluon() const {
    return kEgluon;
}

double GK11ModelOnlyGluons::getEsea() const {
    return kEsea;
}

double GK11ModelOnlyGluons::getEtdval() const {
    return kEtdval;
}

double GK11ModelOnlyGluons::getEtgluon() const {
    return kEtgluon;
}

double GK11ModelOnlyGluons::getEtsea() const {
    return kEtsea;
}

double GK11ModelOnlyGluons::getEtuval() const {
    return kEtuval;
}

double GK11ModelOnlyGluons::getEuval() const {
    return kEuval;
}

double GK11ModelOnlyGluons::getHdval() const {
    return kHdval;
}

double GK11ModelOnlyGluons::getHgluon() const {
    return kHgluon;
}

double GK11ModelOnlyGluons::getHsea() const {
    return kHsea;
}

double GK11ModelOnlyGluons::getHtdval() const {
    return kHtdval;
}

double GK11ModelOnlyGluons::getHtgluon() const {
    return kHtgluon;
}

double GK11ModelOnlyGluons::getHtsea() const {
    return kHtsea;
}

double GK11ModelOnlyGluons::getHtuval() const {
    return kHtuval;
}

double GK11ModelOnlyGluons::getHuval() const {
    return kHuval;
}

std::string GK11ModelOnlyGluons::toString() const {
