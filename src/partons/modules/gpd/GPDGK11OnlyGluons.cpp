...
#include "../../../../include/partons/modules/gpd/GPDGK11OnlyGluons.h"

// Initialise [class]::classId with a unique name.
const unsigned int GPDGK11OnlyGluons::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new GPDGK11OnlyGluons("GPDGK11OnlyGluons"));

//TODO initialise missing members
GPDGK11OnlyGluons::GPDGK11OnlyGluons(const std::string &className) :
        GPDModule(className) {
    m_nf = 3;
    fL = 0.;
    m_MuF2_ref = 4.;
...
GPDGK11OnlyGluons::GPDGK11OnlyGluons(const GPDGK11OnlyGluons& other) :
        GPDModule(other) {
    c1 = other.getC1();
    c2 = other.getC2();
    c3 = other.getC3();
...
GPDGK11OnlyGluons* GPDGK11OnlyGluons::clone() const {
    return new GPDGK11OnlyGluons(*this);
}

GPDGK11OnlyGluons::~GPDGK11OnlyGluons() {
}

void GPDGK11OnlyGluons::configure(const ElemUtils::Parameters &parameters) {
    GPDModule::configure(parameters);
}

//TODO implement
void GPDGK11OnlyGluons::isModuleWellConfigured() {
    GPDModule::isModuleWellConfigured();

}

void GPDGK11OnlyGluons::initModule() {
...
PartonDistribution GPDGK11OnlyGluons::computeH() {
...
PartonDistribution GPDGK11OnlyGluons::computeHt() {
...
PartonDistribution GPDGK11OnlyGluons::computeE() {
    PartonDistribution partonDistribution;
...
PartonDistribution GPDGK11OnlyGluons::computeEt() {
    PartonDistribution partonDistribution;
...
void GPDGK11OnlyGluons::calculateHCoefs() {
...
void GPDGK11OnlyGluons::calculateHKas() {
    double alpha, delta;
...
double GPDGK11OnlyGluons::Hs1(double x, double i, double k) {
...
double GPDGK11OnlyGluons::Hi1(double x, double i, double k) {
...
double GPDGK11OnlyGluons::Hs1_alt(double x, double i, double k) {
...
double GPDGK11OnlyGluons::Hi1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
    cln::cl_R dummya, dummy1, dummy2, dummy3;
...
double GPDGK11OnlyGluons::Hval1(double x, double i, double k) {
...
double GPDGK11OnlyGluons::Hval1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
 ...
 *
 */
void GPDGK11OnlyGluons::calculateHtCoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
void GPDGK11OnlyGluons::calculateHtKas() {
    double alpha, delta;
 ...
 *
 */
double GPDGK11OnlyGluons::Htval1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK11OnlyGluons::Hti1(double x, double i, double k) {
 ...
 *
 */
double GPDGK11OnlyGluons::Hti1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK11OnlyGluons::Htval1(double x, double i, double k) {
 ...
 *
 */
void GPDGK11OnlyGluons::calculateECoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
void GPDGK11OnlyGluons::calculateEKas() {
    double alpha, delta;
 ...
 *
 */
double GPDGK11OnlyGluons::Es1(double x, double i, double k) {
    return Hs1(x, i, k);
}
 ...
 *
 */
double GPDGK11OnlyGluons::Ei1(double x, double i, double k) {
    return Hi1(x, i, k);
}
 ...
 *
 */
double GPDGK11OnlyGluons::Es1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK11OnlyGluons::Ei1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK11OnlyGluons::Eval1(double x, double i, double k) {
    return Hval1(x, i, k);
}
 ...
 *
 */
double GPDGK11OnlyGluons::Eval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}
 ...
 *
 */
void GPDGK11OnlyGluons::calculateEtCoefs() {
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
void GPDGK11OnlyGluons::calculateEtKas() {
    double alpha, delta;
 ...
 *
 */
double GPDGK11OnlyGluons::Et_pole(double x) {
 ...
 *
 */
double GPDGK11OnlyGluons::Etval1(double x, double i, double k) {
    double dum;
 ...
 *
 */
double GPDGK11OnlyGluons::Etval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

double GPDGK11OnlyGluons::getB0() const {
    return b0;
}

double GPDGK11OnlyGluons::getC1() const {
    return c1;
}

double GPDGK11OnlyGluons::getC2() const {
    return c2;
}

double GPDGK11OnlyGluons::getC3() const {
    return c3;
}

double GPDGK11OnlyGluons::getC4() const {
    return c4;
}

double GPDGK11OnlyGluons::getC5() const {
    return c5;
}

double GPDGK11OnlyGluons::getC6() const {
    return c6;
}

double GPDGK11OnlyGluons::getC7() const {
    return c7;
}

double GPDGK11OnlyGluons::getC8() const {
    return c8;
}

const std::vector<double>& GPDGK11OnlyGluons::getEdval1mtab() const {
    return Edval1mtab;
}

const std::vector<double>& GPDGK11OnlyGluons::getEdval1tab() const {
    return Edval1tab;
}

const std::vector<double>& GPDGK11OnlyGluons::getEi1tab() const {
    return Ei1tab;
}

const std::vector<double>& GPDGK11OnlyGluons::getEs1tab() const {
    return Es1tab;
}

const std::vector<double>& GPDGK11OnlyGluons::getEtdval1mtab() const {
    return Etdval1mtab;
}

const std::vector<double>& GPDGK11OnlyGluons::getEtdval1tab() const {
    return Etdval1tab;
}

const std::vector<double>& GPDGK11OnlyGluons::getEtuval1mtab() const {
    return Etuval1mtab;
}

const std::vector<double>& GPDGK11OnlyGluons::getEtuval1tab() const {
    return Etuval1tab;
}

const std::vector<double>& GPDGK11OnlyGluons::getEuval1mtab() const {
    return Euval1mtab;
}

const std::vector<double>& GPDGK11OnlyGluons::getEuval1tab() const {
    return Euval1tab;
}

double GPDGK11OnlyGluons::getEdValMx() const {
    return fEdValMx;
}

double GPDGK11OnlyGluons::getEtdValMx() const {
    return fEtdValMx;
}

double GPDGK11OnlyGluons::getEtuValMx() const {
    return fEtuValMx;
}

double GPDGK11OnlyGluons::getEuValMx() const {
    return fEuValMx;
}

double GPDGK11OnlyGluons::getHdValMx() const {
    return fHdValMx;
}

double GPDGK11OnlyGluons::getHtdValMx() const {
    return fHtdValMx;
}

double GPDGK11OnlyGluons::getHtuValMx() const {
    return fHtuValMx;
}

double GPDGK11OnlyGluons::getHuValMx() const {
    return fHuValMx;
}

double GPDGK11OnlyGluons::getL() const {
    return fL;
}

const std::vector<double>& GPDGK11OnlyGluons::getHdval1mtab() const {
    return Hdval1mtab;
}

const std::vector<double>& GPDGK11OnlyGluons::getHdval1tab() const {
    return Hdval1tab;
}

const std::vector<double>& GPDGK11OnlyGluons::getHi1tab() const {
    return Hi1tab;
}

const std::vector<double>& GPDGK11OnlyGluons::getHs1tab() const {
    return Hs1tab;
}

const std::vector<double>& GPDGK11OnlyGluons::getHtdval1mtab() const {
    return Htdval1mtab;
}

const std::vector<double>& GPDGK11OnlyGluons::getHtdval1tab() const {
    return Htdval1tab;
}

const std::vector<double>& GPDGK11OnlyGluons::getHti1tab() const {
    return Hti1tab;
}

const std::vector<double>& GPDGK11OnlyGluons::getHtuval1mtab() const {
    return Htuval1mtab;
}

const std::vector<double>& GPDGK11OnlyGluons::getHtuval1tab() const {
    return Htuval1tab;
}

const std::vector<double>& GPDGK11OnlyGluons::getHuval1mtab() const {
    return Huval1mtab;
}

const std::vector<double>& GPDGK11OnlyGluons::getHuval1tab() const {
    return Huval1tab;
}

double GPDGK11OnlyGluons::getKappaS() const {
    return kappa_s;
}

double GPDGK11OnlyGluons::getEdval() const {
    return kEdval;
}

double GPDGK11OnlyGluons::getEgluon() const {
    return kEgluon;
}

double GPDGK11OnlyGluons::getEsea() const {
    return kEsea;
}

double GPDGK11OnlyGluons::getEtdval() const {
    return kEtdval;
}

double GPDGK11OnlyGluons::getEtgluon() const {
    return kEtgluon;
}

double GPDGK11OnlyGluons::getEtsea() const {
    return kEtsea;
}

double GPDGK11OnlyGluons::getEtuval() const {
    return kEtuval;
}

double GPDGK11OnlyGluons::getEuval() const {
    return kEuval;
}

double GPDGK11OnlyGluons::getHdval() const {
    return kHdval;
}

double GPDGK11OnlyGluons::getHgluon() const {
    return kHgluon;
}

double GPDGK11OnlyGluons::getHsea() const {
    return kHsea;
}

double GPDGK11OnlyGluons::getHtdval() const {
    return kHtdval;
}

double GPDGK11OnlyGluons::getHtgluon() const {
    return kHtgluon;
}

double GPDGK11OnlyGluons::getHtsea() const {
    return kHtsea;
}

double GPDGK11OnlyGluons::getHtuval() const {
    return kHtuval;
}

double GPDGK11OnlyGluons::getHuval() const {
    return kHuval;
}

std::string GPDGK11OnlyGluons::toString() {
