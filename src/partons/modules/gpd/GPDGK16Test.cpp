...
#include "../../../../include/partons/modules/gpd/GPDGK16Test.h"

// Initialise [class]::classId with a unique name.
const unsigned int GPDGK16Test::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new GPDGK16Test("GPDGK16Test"));

//TODO initialise missing members
GPDGK16Test::GPDGK16Test(const std::string &className) :
        GPDModule(className) {
    m_nf = 3;
    fL = 0.;
    m_MuF2_ref = 4.;
...
GPDGK16Test::GPDGK16Test(const GPDGK16Test& other) :
        GPDModule(other) {
    c1 = other.getC1();
    c2 = other.getC2();
    c3 = other.getC3();
...
GPDGK16Test* GPDGK16Test::clone() const {
    return new GPDGK16Test(*this);
}

GPDGK16Test::~GPDGK16Test() {
}

void GPDGK16Test::configure(const ElemUtils::Parameters &parameters) {
    GPDModule::configure(parameters);
}

//TODO implement
void GPDGK16Test::isModuleWellConfigured() {
    GPDModule::isModuleWellConfigured();

}

void GPDGK16Test::initModule() {
...
PartonDistribution GPDGK16Test::computeH() {
...
PartonDistribution GPDGK16Test::computeHt() {
...
PartonDistribution GPDGK16Test::computeE() {
    PartonDistribution partonDistribution;
...
PartonDistribution GPDGK16Test::computeEt() {
    PartonDistribution partonDistribution;
...
void GPDGK16Test::calculateHCoefs() {
...
void GPDGK16Test::calculateHKas() {
    double alpha, delta;
...
double GPDGK16Test::Hs1(double x, double i, double k) {
...
double GPDGK16Test::Hi1(double x, double i, double k) {
...
double GPDGK16Test::Hs1_alt(double x, double i, double k) {
...
double GPDGK16Test::Hi1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
    cln::cl_R dummya, dummy1, dummy2, dummy3;
...
double GPDGK16Test::Hval1(double x, double i, double k) {
...
double GPDGK16Test::Hval1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
 ...
 *
 */
void GPDGK16Test::calculateHtCoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
void GPDGK16Test::calculateHtKas() {
    double alpha, delta;
 ...
 *
 */
double GPDGK16Test::Htval1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK16Test::Hti1(double x, double i, double k) {
 ...
 *
 */
double GPDGK16Test::Hti1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK16Test::Htval1(double x, double i, double k) {
 ...
 *
 */
void GPDGK16Test::calculateECoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
void GPDGK16Test::calculateEKas() {
    double alpha, delta;
 ...
 *
 */
double GPDGK16Test::Es1(double x, double i, double k) {
    return Hs1(x, i, k);
}
 ...
 *
 */
double GPDGK16Test::Ei1(double x, double i, double k) {
    return Hi1(x, i, k);
}
 ...
 *
 */
double GPDGK16Test::Es1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK16Test::Ei1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK16Test::Eval1(double x, double i, double k) {
    return Hval1(x, i, k);
}
 ...
 *
 */
double GPDGK16Test::Eval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}
 ...
 *
 */
void GPDGK16Test::calculateEtCoefs() {
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
void GPDGK16Test::calculateEtKas() {
    double alpha, delta;
 ...
 *
 */
double GPDGK16Test::Et_pole(double x) {
 ...
 *
 */
double GPDGK16Test::Etval1(double x, double i, double k) {
    double dum;
 ...
 *
 */
double GPDGK16Test::Etval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

double GPDGK16Test::getB0() const {
    return b0;
}

double GPDGK16Test::getC1() const {
    return c1;
}

double GPDGK16Test::getC2() const {
    return c2;
}

double GPDGK16Test::getC3() const {
    return c3;
}

double GPDGK16Test::getC4() const {
    return c4;
}

double GPDGK16Test::getC5() const {
    return c5;
}

double GPDGK16Test::getC6() const {
    return c6;
}

double GPDGK16Test::getC7() const {
    return c7;
}

double GPDGK16Test::getC8() const {
    return c8;
}

const std::vector<double>& GPDGK16Test::getEdval1mtab() const {
    return Edval1mtab;
}

const std::vector<double>& GPDGK16Test::getEdval1tab() const {
    return Edval1tab;
}

const std::vector<double>& GPDGK16Test::getEi1tab() const {
    return Ei1tab;
}

const std::vector<double>& GPDGK16Test::getEs1tab() const {
    return Es1tab;
}

const std::vector<double>& GPDGK16Test::getEtdval1mtab() const {
    return Etdval1mtab;
}

const std::vector<double>& GPDGK16Test::getEtdval1tab() const {
    return Etdval1tab;
}

const std::vector<double>& GPDGK16Test::getEtuval1mtab() const {
    return Etuval1mtab;
}

const std::vector<double>& GPDGK16Test::getEtuval1tab() const {
    return Etuval1tab;
}

const std::vector<double>& GPDGK16Test::getEuval1mtab() const {
    return Euval1mtab;
}

const std::vector<double>& GPDGK16Test::getEuval1tab() const {
    return Euval1tab;
}

double GPDGK16Test::getEdValMx() const {
    return fEdValMx;
}

double GPDGK16Test::getEtdValMx() const {
    return fEtdValMx;
}

double GPDGK16Test::getEtuValMx() const {
    return fEtuValMx;
}

double GPDGK16Test::getEuValMx() const {
    return fEuValMx;
}

double GPDGK16Test::getHdValMx() const {
    return fHdValMx;
}

double GPDGK16Test::getHtdValMx() const {
    return fHtdValMx;
}

double GPDGK16Test::getHtuValMx() const {
    return fHtuValMx;
}

double GPDGK16Test::getHuValMx() const {
    return fHuValMx;
}

double GPDGK16Test::getL() const {
    return fL;
}

const std::vector<double>& GPDGK16Test::getHdval1mtab() const {
    return Hdval1mtab;
}

const std::vector<double>& GPDGK16Test::getHdval1tab() const {
    return Hdval1tab;
}

const std::vector<double>& GPDGK16Test::getHi1tab() const {
    return Hi1tab;
}

const std::vector<double>& GPDGK16Test::getHs1tab() const {
    return Hs1tab;
}

const std::vector<double>& GPDGK16Test::getHtdval1mtab() const {
    return Htdval1mtab;
}

const std::vector<double>& GPDGK16Test::getHtdval1tab() const {
    return Htdval1tab;
}

const std::vector<double>& GPDGK16Test::getHti1tab() const {
    return Hti1tab;
}

const std::vector<double>& GPDGK16Test::getHtuval1mtab() const {
    return Htuval1mtab;
}

const std::vector<double>& GPDGK16Test::getHtuval1tab() const {
    return Htuval1tab;
}

const std::vector<double>& GPDGK16Test::getHuval1mtab() const {
    return Huval1mtab;
}

const std::vector<double>& GPDGK16Test::getHuval1tab() const {
    return Huval1tab;
}

double GPDGK16Test::getKappaS() const {
    return kappa_s;
}

double GPDGK16Test::getEdval() const {
    return kEdval;
}

double GPDGK16Test::getEgluon() const {
    return kEgluon;
}

double GPDGK16Test::getEsea() const {
    return kEsea;
}

double GPDGK16Test::getEtdval() const {
    return kEtdval;
}

double GPDGK16Test::getEtgluon() const {
    return kEtgluon;
}

double GPDGK16Test::getEtsea() const {
    return kEtsea;
}

double GPDGK16Test::getEtuval() const {
    return kEtuval;
}

double GPDGK16Test::getEuval() const {
    return kEuval;
}

double GPDGK16Test::getHdval() const {
    return kHdval;
}

double GPDGK16Test::getHgluon() const {
    return kHgluon;
}

double GPDGK16Test::getHsea() const {
    return kHsea;
}

double GPDGK16Test::getHtdval() const {
    return kHtdval;
}

double GPDGK16Test::getHtgluon() const {
    return kHtgluon;
}

double GPDGK16Test::getHtsea() const {
    return kHtsea;
}

double GPDGK16Test::getHtuval() const {
    return kHtuval;
}

double GPDGK16Test::getHuval() const {
    return kHuval;
}

std::string GPDGK16Test::toString() {
