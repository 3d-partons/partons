...
GPDMPSSW13::GPDMPSSW13(const GPDMPSSW13& other) :
...
void GPDMPSSW13::setParameters(std::vector<double> Parameters) {
...
void GPDMPSSW13::ComputeFormFactors() {
...
double GPDMPSSW13::Profile(double N, double beta, double alpha) {
    double profile;
...
void GPDMPSSW13::throwBetaException(const std::string &funcName,
        double betaValue) {
...
double GPDMPSSW13::IntegralHuVal(double x, std::vector<double> Par) {
    double Integral;
...
double GPDMPSSW13::IntegralHuValMx(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxLargeHuSea(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxLargeHuSeaMx(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxSmall1HuSea(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxSmall2HuSea(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralHdVal(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralHdValMx(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxLargeHdSea(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxLargeHdSeaMx(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxSmall1HdSea(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxSmall2HdSea(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxLargeHsSea(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxLargeHsSeaMx(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxSmall1HsSea(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxSmall2HsSea(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxLargeHg(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxLargeHgMx(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxSmall1Hg(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::IntegralxSmall2Hg(double x, std::vector<double> Par) {
    double Integral;
    double pdf, beta, absbeta;
...
double GPDMPSSW13::GammaQQ(const unsigned int nflavour,
...
double GPDMPSSW13::GammaQG(const unsigned int nflavour,
        const unsigned int n) {
    double Gamma;
...
double GPDMPSSW13::GammaGQ(const unsigned int nflavour,
        const unsigned int n) {
    double Gamma;
...
double GPDMPSSW13::GammaGG(const unsigned int nflavour,
        const unsigned int n) {
    double Gamma;
...
double GPDMPSSW13::getCF() const {
    return m_CF;
}

double GPDMPSSW13::getF1d() const {
    return m_F1d;
}

double GPDMPSSW13::getF1u() const {
    return m_F1u;
}

double GPDMPSSW13::getFD() const {
    return m_FD;
}

double GPDMPSSW13::getGluonDTerm() const {
    return m_GluonDTerm;
}

void GPDMPSSW13::setGluonDTerm(double gluonDTerm) {
    m_GluonDTerm = gluonDTerm;
}

double GPDMPSSW13::getMx() const {
    return m_Mx;
}

unsigned int GPDMPSSW13::getNbOfColor() const {
    return m_NbOfColor;
}

unsigned int GPDMPSSW13::getNbOfQuarkFlavor() const {
    return m_NbOfQuarkFlavor;
}

double GPDMPSSW13::getProfileShapeGlue() const {
    return m_ProfileShapeGlue;
}

double GPDMPSSW13::getProfileShapeSea() const {
    return m_ProfileShapeSea;
}

double GPDMPSSW13::getProfileShapeVal() const {
    return m_ProfileShapeVal;
}

double GPDMPSSW13::getQuarkDTerm() const {
    return m_QuarkDTerm;
}

double GPDMPSSW13::getTF() const {
    return m_TF;
}

PartonDistribution GPDMPSSW13::computeH() {
