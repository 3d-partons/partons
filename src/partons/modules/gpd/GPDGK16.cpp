...
GPDGK16::GPDGK16(const GPDGK16& other) :
        GPDModule(other) {
    c1 = other.getC1();
    c2 = other.getC2();
    c3 = other.getC3();
...
GPDGK16* GPDGK16::clone() const {
    return new GPDGK16(*this);
}

GPDGK16::~GPDGK16() {
}

void GPDGK16::configure(const ElemUtils::Parameters &parameters) {
    GPDModule::configure(parameters);
}

//TODO implement
void GPDGK16::isModuleWellConfigured() {
    GPDModule::isModuleWellConfigured();

}

void GPDGK16::initModule() {
...
PartonDistribution GPDGK16::computeH() {
...
PartonDistribution GPDGK16::computeHt() {
...
PartonDistribution GPDGK16::computeE() {
    PartonDistribution partonDistribution;
...
PartonDistribution GPDGK16::computeEt() {
    PartonDistribution partonDistribution;
...
double GPDGK16::Hs1(double x, double i, double k) {
...
double GPDGK16::Hi1(double x, double i, double k) {
...
double GPDGK16::Hs1_alt(double x, double i, double k) {
...
double GPDGK16::Hi1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
    cln::cl_R dummya, dummy1, dummy2, dummy3;
...
double GPDGK16::Hval1(double x, double i, double k) {
...
double GPDGK16::Hval1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
 ...
 *
 */
double GPDGK16::Htval1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK16::Hti1(double x, double i, double k) {
 ...
 *
 */
double GPDGK16::Hti1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK16::Htval1(double x, double i, double k) {
 ...
 *
 */
double GPDGK16::Es1(double x, double i, double k) {
    return Hs1(x, i, k);
}
 ...
 *
 */
double GPDGK16::Ei1(double x, double i, double k) {
    return Hi1(x, i, k);
}
 ...
 *
 */
double GPDGK16::Es1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK16::Ei1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK16::Eval1(double x, double i, double k) {
    return Hval1(x, i, k);
}
 ...
 *
 */
double GPDGK16::Eval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}
 ...
 *
 */
double GPDGK16::Et_pole(double x) {
 ...
 *
 */
double GPDGK16::Etval1(double x, double i, double k) {
    double dum;
 ...
 *
 */
double GPDGK16::Etval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

double GPDGK16::getB0() const {
    return b0;
}

double GPDGK16::getC1() const {
    return c1;
}

double GPDGK16::getC2() const {
    return c2;
}

double GPDGK16::getC3() const {
    return c3;
}

double GPDGK16::getC4() const {
    return c4;
}

double GPDGK16::getC5() const {
    return c5;
}

double GPDGK16::getC6() const {
    return c6;
}

double GPDGK16::getC7() const {
    return c7;
}

double GPDGK16::getC8() const {
    return c8;
}

const std::vector<double>& GPDGK16::getEdval1mtab() const {
    return Edval1mtab;
}

const std::vector<double>& GPDGK16::getEdval1tab() const {
    return Edval1tab;
}

const std::vector<double>& GPDGK16::getEi1tab() const {
    return Ei1tab;
}

const std::vector<double>& GPDGK16::getEs1tab() const {
    return Es1tab;
}

const std::vector<double>& GPDGK16::getEtdval1mtab() const {
    return Etdval1mtab;
}

const std::vector<double>& GPDGK16::getEtdval1tab() const {
    return Etdval1tab;
}

const std::vector<double>& GPDGK16::getEtuval1mtab() const {
    return Etuval1mtab;
}

const std::vector<double>& GPDGK16::getEtuval1tab() const {
    return Etuval1tab;
}

const std::vector<double>& GPDGK16::getEuval1mtab() const {
    return Euval1mtab;
}

const std::vector<double>& GPDGK16::getEuval1tab() const {
    return Euval1tab;
}

double GPDGK16::getEdValMx() const {
    return fEdValMx;
}

double GPDGK16::getEtdValMx() const {
    return fEtdValMx;
}

double GPDGK16::getEtuValMx() const {
    return fEtuValMx;
}

double GPDGK16::getEuValMx() const {
    return fEuValMx;
}

double GPDGK16::getHdValMx() const {
    return fHdValMx;
}

double GPDGK16::getHtdValMx() const {
    return fHtdValMx;
}

double GPDGK16::getHtuValMx() const {
    return fHtuValMx;
}

double GPDGK16::getHuValMx() const {
    return fHuValMx;
}

double GPDGK16::getL() const {
    return fL;
}

const std::vector<double>& GPDGK16::getHdval1mtab() const {
    return Hdval1mtab;
}

const std::vector<double>& GPDGK16::getHdval1tab() const {
    return Hdval1tab;
}

const std::vector<double>& GPDGK16::getHi1tab() const {
    return Hi1tab;
}

const std::vector<double>& GPDGK16::getHs1tab() const {
    return Hs1tab;
}

const std::vector<double>& GPDGK16::getHtdval1mtab() const {
    return Htdval1mtab;
}

const std::vector<double>& GPDGK16::getHtdval1tab() const {
    return Htdval1tab;
}

const std::vector<double>& GPDGK16::getHti1tab() const {
    return Hti1tab;
}

const std::vector<double>& GPDGK16::getHtuval1mtab() const {
    return Htuval1mtab;
}

const std::vector<double>& GPDGK16::getHtuval1tab() const {
    return Htuval1tab;
}

const std::vector<double>& GPDGK16::getHuval1mtab() const {
    return Huval1mtab;
}

const std::vector<double>& GPDGK16::getHuval1tab() const {
    return Huval1tab;
}

double GPDGK16::getKappaS() const {
    return kappa_s;
}

double GPDGK16::getEdval() const {
    return kEdval;
}

double GPDGK16::getEgluon() const {
    return kEgluon;
}

double GPDGK16::getEsea() const {
    return kEsea;
}

double GPDGK16::getEtdval() const {
    return kEtdval;
}

double GPDGK16::getEtgluon() const {
    return kEtgluon;
}

double GPDGK16::getEtsea() const {
    return kEtsea;
}

double GPDGK16::getEtuval() const {
    return kEtuval;
}

double GPDGK16::getEuval() const {
    return kEuval;
}

double GPDGK16::getHdval() const {
    return kHdval;
}

double GPDGK16::getHgluon() const {
    return kHgluon;
}

double GPDGK16::getHsea() const {
    return kHsea;
}

double GPDGK16::getHtdval() const {
    return kHtdval;
}

double GPDGK16::getHtgluon() const {
    return kHtgluon;
}

double GPDGK16::getHtsea() const {
    return kHtsea;
}

double GPDGK16::getHtuval() const {
    return kHtuval;
}

double GPDGK16::getHuval() const {
    return kHuval;
}
