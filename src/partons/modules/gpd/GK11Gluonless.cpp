#include "../../../../include/partons/modules/gpd/GK11Gluonless.h"
...
const unsigned int GK11Gluonless::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new GK11Gluonless("GK11Gluonless"));

//TODO initialise missing members
GK11Gluonless::GK11Gluonless(const std::string &className) :
        GPDModule(className) {
    fL = 0.;
    m_MuF2_ref = 4.;
...
GK11Gluonless::GK11Gluonless(const GK11Gluonless& other) :
        GPDModule(other) {
    c1 = other.getC1();
    c2 = other.getC2();
    c3 = other.getC3();
...
GK11Gluonless* GK11Gluonless::clone() const {
    return new GK11Gluonless(*this);
}

GK11Gluonless::~GK11Gluonless() {
}

void GK11Gluonless::configure(const ElemUtils::Parameters &parameters) {
    GPDModule::configure(parameters);
}

//TODO implement
void GK11Gluonless::isModuleWellConfigured() {
    GPDModule::isModuleWellConfigured();

}

void GK11Gluonless::initModule() {
...
PartonDistribution GK11Gluonless::computeH() {
...
PartonDistribution GK11Gluonless::computeHt() {
...
PartonDistribution GK11Gluonless::computeE() {
    PartonDistribution partonDistribution;
...
PartonDistribution GK11Gluonless::computeEt() {
    PartonDistribution partonDistribution;
...
void GK11Gluonless::calculateHCoefs() {
...
void GK11Gluonless::calculateHKas() {
    double alpha, delta;
...
double GK11Gluonless::Hs1(double x, double i, double k) {
...
double GK11Gluonless::Hi1(double x, double i, double k) {
...
double GK11Gluonless::Hs1_alt(double x, double i, double k) {
...
double GK11Gluonless::Hi1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
    cln::cl_R dummya, dummy1, dummy2, dummy3;
...
double GK11Gluonless::Hval1(double x, double i, double k) {
...
double GK11Gluonless::Hval1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
 ...
 *
 */
void GK11Gluonless::calculateHtCoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
void GK11Gluonless::calculateHtKas() {
    double alpha, delta;
 ...
 *
 */
double GK11Gluonless::Htval1_alt(double x, double i, double k) {
 ...
 *
 */
double GK11Gluonless::Hti1(double x, double i, double k) {
 ...
 *
 */
double GK11Gluonless::Hti1_alt(double x, double i, double k) {
 ...
 *
 */
double GK11Gluonless::Htval1(double x, double i, double k) {
 ...
 *
 */
void GK11Gluonless::calculateECoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
void GK11Gluonless::calculateEKas() {
    double alpha, delta;
 ...
 *
 */
double GK11Gluonless::Es1(double x, double i, double k) {
    return Hs1(x, i, k);
}
 ...
 *
 */
double GK11Gluonless::Ei1(double x, double i, double k) {
    return Hi1(x, i, k);
}
 ...
 *
 */
double GK11Gluonless::Es1_alt(double x, double i, double k) {
 ...
 *
 */
double GK11Gluonless::Ei1_alt(double x, double i, double k) {
 ...
 *
 */
double GK11Gluonless::Eval1(double x, double i, double k) {
    return Hval1(x, i, k);
}
 ...
 *
 */
double GK11Gluonless::Eval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}
 ...
 *
 */
void GK11Gluonless::calculateEtCoefs() {
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
void GK11Gluonless::calculateEtKas() {
    double alpha, delta;
 ...
 *
 */
double GK11Gluonless::Et_pole(double x) {
 ...
 *
 */
double GK11Gluonless::Etval1(double x, double i, double k) {
    double dum;
 ...
 *
 */
double GK11Gluonless::Etval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

double GK11Gluonless::getB0() const {
    return b0;
}

double GK11Gluonless::getC1() const {
    return c1;
}

double GK11Gluonless::getC2() const {
    return c2;
}

double GK11Gluonless::getC3() const {
    return c3;
}

double GK11Gluonless::getC4() const {
    return c4;
}

double GK11Gluonless::getC5() const {
    return c5;
}

double GK11Gluonless::getC6() const {
    return c6;
}

double GK11Gluonless::getC7() const {
    return c7;
}

double GK11Gluonless::getC8() const {
    return c8;
}

const std::vector<double>& GK11Gluonless::getEdval1mtab() const {
    return Edval1mtab;
}

const std::vector<double>& GK11Gluonless::getEdval1tab() const {
    return Edval1tab;
}

const std::vector<double>& GK11Gluonless::getEi1tab() const {
    return Ei1tab;
}

const std::vector<double>& GK11Gluonless::getEs1tab() const {
    return Es1tab;
}

const std::vector<double>& GK11Gluonless::getEtdval1mtab() const {
    return Etdval1mtab;
}

const std::vector<double>& GK11Gluonless::getEtdval1tab() const {
    return Etdval1tab;
}

const std::vector<double>& GK11Gluonless::getEtuval1mtab() const {
    return Etuval1mtab;
}

const std::vector<double>& GK11Gluonless::getEtuval1tab() const {
    return Etuval1tab;
}

const std::vector<double>& GK11Gluonless::getEuval1mtab() const {
    return Euval1mtab;
}

const std::vector<double>& GK11Gluonless::getEuval1tab() const {
    return Euval1tab;
}

double GK11Gluonless::getEdValMx() const {
    return fEdValMx;
}

double GK11Gluonless::getEtdValMx() const {
    return fEtdValMx;
}

double GK11Gluonless::getEtuValMx() const {
    return fEtuValMx;
}

double GK11Gluonless::getEuValMx() const {
    return fEuValMx;
}

double GK11Gluonless::getHdValMx() const {
    return fHdValMx;
}

double GK11Gluonless::getHtdValMx() const {
    return fHtdValMx;
}

double GK11Gluonless::getHtuValMx() const {
    return fHtuValMx;
}

double GK11Gluonless::getHuValMx() const {
    return fHuValMx;
}

double GK11Gluonless::getL() const {
    return fL;
}

const std::vector<double>& GK11Gluonless::getHdval1mtab() const {
    return Hdval1mtab;
}

const std::vector<double>& GK11Gluonless::getHdval1tab() const {
    return Hdval1tab;
}

const std::vector<double>& GK11Gluonless::getHi1tab() const {
    return Hi1tab;
}

const std::vector<double>& GK11Gluonless::getHs1tab() const {
    return Hs1tab;
}

const std::vector<double>& GK11Gluonless::getHtdval1mtab() const {
    return Htdval1mtab;
}

const std::vector<double>& GK11Gluonless::getHtdval1tab() const {
    return Htdval1tab;
}

const std::vector<double>& GK11Gluonless::getHti1tab() const {
    return Hti1tab;
}

const std::vector<double>& GK11Gluonless::getHtuval1mtab() const {
    return Htuval1mtab;
}

const std::vector<double>& GK11Gluonless::getHtuval1tab() const {
    return Htuval1tab;
}

const std::vector<double>& GK11Gluonless::getHuval1mtab() const {
    return Huval1mtab;
}

const std::vector<double>& GK11Gluonless::getHuval1tab() const {
    return Huval1tab;
}

double GK11Gluonless::getKappaS() const {
    return kappa_s;
}

double GK11Gluonless::getEdval() const {
    return kEdval;
}

double GK11Gluonless::getEgluon() const {
    return kEgluon;
}

double GK11Gluonless::getEsea() const {
    return kEsea;
}

double GK11Gluonless::getEtdval() const {
    return kEtdval;
}

double GK11Gluonless::getEtgluon() const {
    return kEtgluon;
}

double GK11Gluonless::getEtsea() const {
    return kEtsea;
}

double GK11Gluonless::getEtuval() const {
    return kEtuval;
}

double GK11Gluonless::getEuval() const {
    return kEuval;
}

double GK11Gluonless::getHdval() const {
    return kHdval;
}

double GK11Gluonless::getHgluon() const {
    return kHgluon;
}

double GK11Gluonless::getHsea() const {
    return kHsea;
}

double GK11Gluonless::getHtdval() const {
    return kHtdval;
}

double GK11Gluonless::getHtgluon() const {
    return kHtgluon;
}

double GK11Gluonless::getHtsea() const {
    return kHtsea;
}

double GK11Gluonless::getHtuval() const {
    return kHtuval;
}

double GK11Gluonless::getHuval() const {
    return kHuval;
}
