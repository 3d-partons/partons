#include "../../../../include/partons/modules/gpd/GPDVGG99.h"
...
GPDVGG99::GPDVGG99(const GPDVGG99& other) :
...
void GPDVGG99::initFunctorsForIntegrations() {

    m_pint_symm_double_distr_reggeH = NumA::Integrator1D::newIntegrationFunctor(
            this, &GPDVGG99::int_symm_double_distr_reggeH);

    m_pint_symm_double_distr_reggeMxH =
            NumA::Integrator1D::newIntegrationFunctor(this,
                    &GPDVGG99::int_symm_double_distr_reggeMxH);

    m_pint_symm_double_distr_reggeE = NumA::Integrator1D::newIntegrationFunctor(
            this, &GPDVGG99::int_symm_double_distr_reggeE);

    m_pint_symm_double_distr_reggeMxE =
            NumA::Integrator1D::newIntegrationFunctor(this,
                    &GPDVGG99::int_symm_double_distr_reggeMxE);

    m_pint_symm_double_distr_reggeHt =
            NumA::Integrator1D::newIntegrationFunctor(this,
                    &GPDVGG99::int_symm_double_distr_reggeHt);

    m_pint_symm_double_distr_reggeMxHt =
            NumA::Integrator1D::newIntegrationFunctor(this,
                    &GPDVGG99::int_symm_double_distr_reggeMxHt);

    m_pint_mom2_up_valence_e = NumA::Integrator1D::newIntegrationFunctor(this,
            &GPDVGG99::int_mom2_up_valence_e);
}

GPDVGG99* GPDVGG99::clone() const {
    return new GPDVGG99(*this);
}

void GPDVGG99::resolveObjectDependencies() {
...
PartonDistribution GPDVGG99::computeE() {
...
PartonDistribution GPDVGG99::computeHt() {
...
PartonDistribution GPDVGG99::computeEt() {
...
double GPDVGG99::offforward_distr() {
...
double GPDVGG99::symm_double_distr_reggeH(double beta, double alpha) {
...
double GPDVGG99::symm_double_distr_reggeE(double beta, double alpha) {
...
double GPDVGG99::symm_profile_function(double beta, double alpha,
        double b_profile) {
...
double GPDVGG99::int_symm_double_distr_reggeH(double alpha,
        std::vector<double> par) {
    return symm_double_distr_reggeH(x_s5 - m_xi * alpha, alpha);
}

double GPDVGG99::int_symm_double_distr_reggeMxH(double alpha,
        std::vector<double> par) {
    return symm_double_distr_reggeH(-x_s5 - m_xi * alpha, alpha);
}

double GPDVGG99::int_symm_double_distr_reggeE(double alpha,
        std::vector<double> par) {
    return symm_double_distr_reggeE(x_s5 - m_xi * alpha, alpha);
}

double GPDVGG99::int_symm_double_distr_reggeMxE(double alpha,
        std::vector<double> par) {
    return symm_double_distr_reggeE(-x_s5 - m_xi * alpha, alpha);
}

double GPDVGG99::int_mom2_up_valence_e(double beta, std::vector<double> par) {
...
double GPDVGG99::offforward_pol_distr() {
...
double GPDVGG99::int_symm_double_distr_reggeHt(double alpha,
        std::vector<double> par) {
    return symm_double_distr_reggeHt(
            (x_s5 + m_xi) / (1. + m_xi) - 2 * m_xi / (1. + m_xi) * alpha, alpha);
}

double GPDVGG99::int_symm_double_distr_reggeMxHt(double alpha,
        std::vector<double> par) {
    return symm_double_distr_reggeHt(
...
double GPDVGG99::symm_double_distr_reggeHt(double beta, double alpha) {
...
double GPDVGG99::test_pdf_down_val(double x) {
...
double GPDVGG99::test_pdf_up_val(double x) {
...
double GPDVGG99::test_pdf_sea(double x) {
...
double GPDVGG99::test_pdf_up_bar(double x) {
    return 1. / 5. * test_pdf_sea(x);
}

double GPDVGG99::test_pdf_down_bar(double x) {
    return 1. / 5. * test_pdf_sea(x);
}

double GPDVGG99::pol_up_valence(double x) {
...
double GPDVGG99::pol_down_valence(double x) {
...
double GPDVGG99::pol_strange_bar(double x) {
...
double GPDVGG99::pol_up_bar(double x) {
    return pol_strange_bar(x);
}

double GPDVGG99::pol_down_bar(double x) {
    return pol_strange_bar(x);
}

double GPDVGG99::form_factor_G_A(double Q_sqr) {
...
double GPDVGG99::form_factor_G_P(double t) {
