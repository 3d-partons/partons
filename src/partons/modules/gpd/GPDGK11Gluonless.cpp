...
#include "../../../../include/partons/modules/gpd/GPDGK11Gluonless.h"

// Initialise [class]::classId with a unique name.
const unsigned int GPDGK11Gluonless::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new GPDGK11Gluonless("GPDGK11Gluonless"));

//TODO initialise missing members
GPDGK11Gluonless::GPDGK11Gluonless(const std::string &className) :
        GPDModule(className) {
    m_nf = 3;
    fL = 0.;
    m_MuF2_ref = 4.;
...
GPDGK11Gluonless::GPDGK11Gluonless(const GPDGK11Gluonless& other) :
        GPDModule(other) {
    c1 = other.getC1();
    c2 = other.getC2();
    c3 = other.getC3();
...
GPDGK11Gluonless* GPDGK11Gluonless::clone() const {
    return new GPDGK11Gluonless(*this);
}

GPDGK11Gluonless::~GPDGK11Gluonless() {
}

void GPDGK11Gluonless::configure(const ElemUtils::Parameters &parameters) {
    GPDModule::configure(parameters);
}

//TODO implement
void GPDGK11Gluonless::isModuleWellConfigured() {
    GPDModule::isModuleWellConfigured();

}

void GPDGK11Gluonless::initModule() {
...
PartonDistribution GPDGK11Gluonless::computeH() {
...
PartonDistribution GPDGK11Gluonless::computeHt() {
...
PartonDistribution GPDGK11Gluonless::computeE() {
    PartonDistribution partonDistribution;
...
PartonDistribution GPDGK11Gluonless::computeEt() {
    PartonDistribution partonDistribution;
...
//double GK11Gluonless::computeSinglet(const QuarkDistribution &quarkDistribution_u,
...
void GPDGK11Gluonless::calculateHCoefs() {
...
void GPDGK11Gluonless::calculateHKas() {
    double alpha, delta;
...
double GPDGK11Gluonless::Hs1(double x, double i, double k) {
...
double GPDGK11Gluonless::Hi1(double x, double i, double k) {
...
double GPDGK11Gluonless::Hs1_alt(double x, double i, double k) {
...
double GPDGK11Gluonless::Hi1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
    cln::cl_R dummya, dummy1, dummy2, dummy3;
...
double GPDGK11Gluonless::Hval1(double x, double i, double k) {
...
double GPDGK11Gluonless::Hval1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
...
/** !
 *  \fn void STGK11Gluonless::calculateHtCoefs()
 *
 ...
 *
 */
void GPDGK11Gluonless::calculateHtCoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
...
/*!
 * \fn void STGK11Gluonless::calculateHtKas()
 *
 * Compute t-dependence of GPD Ht correlated to x.
 *
 */
void GPDGK11Gluonless::calculateHtKas() {
    double alpha, delta;
...
/*!
 * \fn void STGK11Gluonless::CalculateEtKas()
 *
 * Exactly the same as Hval1_alt and Eval1_alt.
 *
 */
double GPDGK11Gluonless::Htval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

/*!
 * \fn double STGK11Gluonless::Hti1( double x, double i, double k )
 *
 * Exactly the same as Hs1.
 *
 */
double GPDGK11Gluonless::Hti1(double x, double i, double k) {
 ...
 *
 */
double GPDGK11Gluonless::Hti1_alt(double x, double i, double k) {
 ...
 *
 */
double GPDGK11Gluonless::Htval1(double x, double i, double k) {

    return Hval1(x, i, k);
}

/** !
 *  \fn void STGK11Gluonless::calculateECoefs()
 *
 * Generic function for fast calculation.
 *
 * Calculates :
 ...
 *
 */
void GPDGK11Gluonless::calculateECoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
...
/*!
 * \fn void STGK11Gluonless::calculateEKas()
 *
 * Compute t-dependence of GPD H correlated to x.
 *
 */
void GPDGK11Gluonless::calculateEKas() {
    double alpha, delta;
...
/*!
 * \fn double STGK11Gluonless::Es1( double x, double i, double k )
 *
 * Exactly the same as Hs1.
 *
 */
double GPDGK11Gluonless::Es1(double x, double i, double k) {
    return Hs1(x, i, k);
}

/*!
 * \fn double STGK11Gluonless::Ei1( double x, double i, double k )
 *
 * Exactly the same as Hi1.
 *
 */
double GPDGK11Gluonless::Ei1(double x, double i, double k) {
    return Hi1(x, i, k);
}

/*!
 * \fn double STGK11Gluonless::Es1_alt( double x, double i, double k )
 *
 * Exactly the same as Hs1_alt.
 *
 */
double GPDGK11Gluonless::Es1_alt(double x, double i, double k) {
    return Hs1_alt(x, i, k);
}

/*!
 * \fn double STGK11Gluonless::Ei1_alt( double x, double i, double k )
 *
 * Exactly the same as Hi1_alt.
 *
 */
double GPDGK11Gluonless::Ei1_alt(double x, double i, double k) {
    return Hi1_alt(x, i, k);
}

/*!
 * \fn double STGK11Gluonless::Eval1( double x, double i, double k )
 *
 * Exactly the same as Hval1.
 *
 */
double GPDGK11Gluonless::Eval1(double x, double i, double k) {
    return Hval1(x, i, k);
}
 ...
 *
 */
double GPDGK11Gluonless::Eval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

/** !
 *  \fn void STGK11Gluonless::calculateEtCoefs()
 *
 * Generic function for fast calculation.
 *
 * Calculates :
 ...
 *
 */
void GPDGK11Gluonless::calculateEtCoefs() {
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
 ...
 *
 */
void GPDGK11Gluonless::calculateEtKas() {
    double alpha, delta;
...
/* !
 *  \fn double STGK11Gluonless::Et_pole( double x )
 *
 *  Pion pole contribution to Et.
 *
 */
double GPDGK11Gluonless::Et_pole(double x) {
...
/*!
 * \fn double STGK11Gluonless::Etval1( double x, double i, double k )
 *
 ...
 *
 */
double GPDGK11Gluonless::Etval1(double x, double i, double k) {
    double dum;
...
/*!
 * \fn double STGK11Gluonless::Etval1_alt( double x, double i, double k )
 *
 * Exactly the same as Hval1_alt and Eval1_alt, Htval1_alt.
 *
 */
double GPDGK11Gluonless::Etval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

double GPDGK11Gluonless::getB0() const {
    return b0;
}

double GPDGK11Gluonless::getC1() const {
    return c1;
}

double GPDGK11Gluonless::getC2() const {
    return c2;
}

double GPDGK11Gluonless::getC3() const {
    return c3;
}

double GPDGK11Gluonless::getC4() const {
    return c4;
}

double GPDGK11Gluonless::getC5() const {
    return c5;
}

double GPDGK11Gluonless::getC6() const {
    return c6;
}

double GPDGK11Gluonless::getC7() const {
    return c7;
}

double GPDGK11Gluonless::getC8() const {
    return c8;
}

const std::vector<double>& GPDGK11Gluonless::getEdval1mtab() const {
    return Edval1mtab;
}

const std::vector<double>& GPDGK11Gluonless::getEdval1tab() const {
    return Edval1tab;
}

const std::vector<double>& GPDGK11Gluonless::getEi1tab() const {
    return Ei1tab;
}

const std::vector<double>& GPDGK11Gluonless::getEs1tab() const {
    return Es1tab;
}

const std::vector<double>& GPDGK11Gluonless::getEtdval1mtab() const {
    return Etdval1mtab;
}

const std::vector<double>& GPDGK11Gluonless::getEtdval1tab() const {
    return Etdval1tab;
}

const std::vector<double>& GPDGK11Gluonless::getEtuval1mtab() const {
    return Etuval1mtab;
}

const std::vector<double>& GPDGK11Gluonless::getEtuval1tab() const {
    return Etuval1tab;
}

const std::vector<double>& GPDGK11Gluonless::getEuval1mtab() const {
    return Euval1mtab;
}

const std::vector<double>& GPDGK11Gluonless::getEuval1tab() const {
    return Euval1tab;
}

double GPDGK11Gluonless::getEdValMx() const {
    return fEdValMx;
}

double GPDGK11Gluonless::getEtdValMx() const {
    return fEtdValMx;
}

double GPDGK11Gluonless::getEtuValMx() const {
    return fEtuValMx;
}

double GPDGK11Gluonless::getEuValMx() const {
    return fEuValMx;
}

double GPDGK11Gluonless::getHdValMx() const {
    return fHdValMx;
}

double GPDGK11Gluonless::getHtdValMx() const {
    return fHtdValMx;
}

double GPDGK11Gluonless::getHtuValMx() const {
    return fHtuValMx;
}

double GPDGK11Gluonless::getHuValMx() const {
    return fHuValMx;
}

double GPDGK11Gluonless::getL() const {
    return fL;
}

const std::vector<double>& GPDGK11Gluonless::getHdval1mtab() const {
    return Hdval1mtab;
}

const std::vector<double>& GPDGK11Gluonless::getHdval1tab() const {
    return Hdval1tab;
}

const std::vector<double>& GPDGK11Gluonless::getHi1tab() const {
    return Hi1tab;
}

const std::vector<double>& GPDGK11Gluonless::getHs1tab() const {
    return Hs1tab;
}

const std::vector<double>& GPDGK11Gluonless::getHtdval1mtab() const {
    return Htdval1mtab;
}

const std::vector<double>& GPDGK11Gluonless::getHtdval1tab() const {
    return Htdval1tab;
}

const std::vector<double>& GPDGK11Gluonless::getHti1tab() const {
    return Hti1tab;
}

const std::vector<double>& GPDGK11Gluonless::getHtuval1mtab() const {
    return Htuval1mtab;
}

const std::vector<double>& GPDGK11Gluonless::getHtuval1tab() const {
    return Htuval1tab;
}

const std::vector<double>& GPDGK11Gluonless::getHuval1mtab() const {
    return Huval1mtab;
}

const std::vector<double>& GPDGK11Gluonless::getHuval1tab() const {
    return Huval1tab;
}

double GPDGK11Gluonless::getKappaS() const {
    return kappa_s;
}

double GPDGK11Gluonless::getEdval() const {
    return kEdval;
}

double GPDGK11Gluonless::getEgluon() const {
    return kEgluon;
}

double GPDGK11Gluonless::getEsea() const {
    return kEsea;
}

double GPDGK11Gluonless::getEtdval() const {
    return kEtdval;
}

double GPDGK11Gluonless::getEtgluon() const {
    return kEtgluon;
}

double GPDGK11Gluonless::getEtsea() const {
    return kEtsea;
}

double GPDGK11Gluonless::getEtuval() const {
    return kEtuval;
}

double GPDGK11Gluonless::getEuval() const {
    return kEuval;
}

double GPDGK11Gluonless::getHdval() const {
    return kHdval;
}

double GPDGK11Gluonless::getHgluon() const {
    return kHgluon;
}

double GPDGK11Gluonless::getHsea() const {
    return kHsea;
}

double GPDGK11Gluonless::getHtdval() const {
    return kHtdval;
}

double GPDGK11Gluonless::getHtgluon() const {
    return kHtgluon;
}

double GPDGK11Gluonless::getHtsea() const {
    return kHtsea;
}

double GPDGK11Gluonless::getHtuval() const {
    return kHtuval;
}

double GPDGK11Gluonless::getHuval() const {
    return kHuval;
}

std::string GPDGK11Gluonless::toString() {
