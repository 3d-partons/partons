#include "../../../../include/partons/modules/gpd/GK16Model.h"
...
const unsigned int GK16Model::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new GK16Model("GK16Model"));

//TODO initialise missing members
GK16Model::GK16Model(const std::string &className) :
        GPDModule(className) {
    m_nf = 3;
    fL = 0.;
    m_MuF2_ref = 4.;
...
GK16Model::GK16Model(const GK16Model& other) :
        GPDModule(other) {
    c1 = other.getC1();
    c2 = other.getC2();
    c3 = other.getC3();
...
GK16Model* GK16Model::clone() const {
    return new GK16Model(*this);
}

GK16Model::~GK16Model() {
}

void GK16Model::configure(const ElemUtils::Parameters &parameters) {
    GPDModule::configure(parameters);
}

//TODO implement
void GK16Model::isModuleWellConfigured() {
    GPDModule::isModuleWellConfigured();

}

void GK16Model::initModule() {
...
PartonDistribution GK16Model::computeH() {
...
PartonDistribution GK16Model::computeHt() {
...
PartonDistribution GK16Model::computeE() {
    PartonDistribution partonDistribution;
...
PartonDistribution GK16Model::computeEt() {
    PartonDistribution partonDistribution;
...
//double GK16Model::computeSinglet(const QuarkDistribution &quarkDistribution_u,
...
void GK16Model::calculateHCoefs() {
...
double GK16Model::Hs1(double x, double i, double k) {
...
double GK16Model::Hi1(double x, double i, double k) {
...
double GK16Model::Hs1_alt(double x, double i, double k) {
...
double GK16Model::Hi1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
    cln::cl_R dummya, dummy1, dummy2, dummy3;
...
double GK16Model::Hval1(double x, double i, double k) {
...
double GK16Model::Hval1_alt(double x, double i, double k) {
    cln::cl_R ia, ka, xba, xia;
...
/** !
 *  \fn void STGK16Model::calculateHtCoefs()
 *
 ...
 *
 */
void GK16Model::calculateHtCoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
...
/*!
 * \fn void STGK16Model::calculateHtKas()
 *
 * Compute t-dependence of GPD Ht correlated to x.
 *
 */
void GK16Model::calculateHtKas() {
    double alpha, delta;
...
/*!
 * \fn void STGK16Model::CalculateEtKas()
 *
 * Exactly the same as Hval1_alt and Eval1_alt.
 *
 */
double GK16Model::Htval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

/*!
 * \fn double STGK16Model::Hti1( double x, double i, double k )
 *
 * Exactly the same as Hs1.
 *
 */
double GK16Model::Hti1(double x, double i, double k) {
 ...
 *
 */
double GK16Model::Hti1_alt(double x, double i, double k) {
 ...
 *
 */
double GK16Model::Htval1(double x, double i, double k) {

    return Hval1(x, i, k);
}

/** !
 *  \fn void STGK16Model::calculateECoefs()
 *
 * Generic function for fast calculation.
 *
 * Calculates :
 ...
 *
 */
void GK16Model::calculateECoefs() {
    int slow_sea = 0; // by default,  fast
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
...
/*!
 * \fn void STGK16Model::calculateEKas()
 *
 * Compute t-dependence of GPD H correlated to x.
 *
 */
void GK16Model::calculateEKas() {
    double alpha, delta;
...
/*!
 * \fn double STGK16Model::Es1( double x, double i, double k )
 *
 * Exactly the same as Hs1.
 *
 */
double GK16Model::Es1(double x, double i, double k) {
    return Hs1(x, i, k);
}

/*!
 * \fn double STGK16Model::Ei1( double x, double i, double k )
 *
 * Exactly the same as Hi1.
 *
 */
double GK16Model::Ei1(double x, double i, double k) {
    return Hi1(x, i, k);
}

/*!
 * \fn double STGK16Model::Es1_alt( double x, double i, double k )
 *
 * Exactly the same as Hs1_alt.
 *
 */
double GK16Model::Es1_alt(double x, double i, double k) {
    return Hs1_alt(x, i, k);
}

/*!
 * \fn double STGK16Model::Ei1_alt( double x, double i, double k )
 *
 * Exactly the same as Hi1_alt.
 *
 */
double GK16Model::Ei1_alt(double x, double i, double k) {
    return Hi1_alt(x, i, k);
}

/*!
 * \fn double STGK16Model::Eval1( double x, double i, double k )
 *
 * Exactly the same as Hval1.
 *
 */
double GK16Model::Eval1(double x, double i, double k) {
    return Hval1(x, i, k);
}
 ...
 *
 */
double GK16Model::Eval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

/** !
 *  \fn void STGK16Model::calculateEtCoefs()
 *
 * Generic function for fast calculation.
 *
 * Calculates :
 ...
 *
 */
void GK16Model::calculateEtCoefs() {
    int slow_val = 0; // if  =  1 : slow ( full calculation with cln )
...
/* !
 *  \fn double STGK16Model::Et_pole( double x )
 *
 *  Pion pole contribution to Et.
 *
 */
double GK16Model::Et_pole(double x) {
...
/*!
 * \fn double STGK16Model::Etval1( double x, double i, double k )
 *
 ...
 *
 */
double GK16Model::Etval1(double x, double i, double k) {
    double dum;
...
/*!
 * \fn double STGK16Model::Etval1_alt( double x, double i, double k )
 *
 * Exactly the same as Hval1_alt and Eval1_alt, Htval1_alt.
 *
 */
double GK16Model::Etval1_alt(double x, double i, double k) {
    return Hval1_alt(x, i, k);
}

double GK16Model::getB0() const {
    return b0;
}

double GK16Model::getC1() const {
    return c1;
}

double GK16Model::getC2() const {
    return c2;
}

double GK16Model::getC3() const {
    return c3;
}

double GK16Model::getC4() const {
    return c4;
}

double GK16Model::getC5() const {
    return c5;
}

double GK16Model::getC6() const {
    return c6;
}

double GK16Model::getC7() const {
    return c7;
}

double GK16Model::getC8() const {
    return c8;
}

const std::vector<double>& GK16Model::getEdval1mtab() const {
    return Edval1mtab;
}

const std::vector<double>& GK16Model::getEdval1tab() const {
    return Edval1tab;
}

const std::vector<double>& GK16Model::getEi1tab() const {
    return Ei1tab;
}

const std::vector<double>& GK16Model::getEs1tab() const {
    return Es1tab;
}

const std::vector<double>& GK16Model::getEtdval1mtab() const {
    return Etdval1mtab;
}

const std::vector<double>& GK16Model::getEtdval1tab() const {
    return Etdval1tab;
}

const std::vector<double>& GK16Model::getEtuval1mtab() const {
    return Etuval1mtab;
}

const std::vector<double>& GK16Model::getEtuval1tab() const {
    return Etuval1tab;
}

const std::vector<double>& GK16Model::getEuval1mtab() const {
    return Euval1mtab;
}

const std::vector<double>& GK16Model::getEuval1tab() const {
    return Euval1tab;
}

double GK16Model::getEdValMx() const {
    return fEdValMx;
}

double GK16Model::getEtdValMx() const {
    return fEtdValMx;
}

double GK16Model::getEtuValMx() const {
    return fEtuValMx;
}

double GK16Model::getEuValMx() const {
    return fEuValMx;
}

double GK16Model::getHdValMx() const {
    return fHdValMx;
}

double GK16Model::getHtdValMx() const {
    return fHtdValMx;
}

double GK16Model::getHtuValMx() const {
    return fHtuValMx;
}

double GK16Model::getHuValMx() const {
    return fHuValMx;
}

double GK16Model::getL() const {
    return fL;
}

const std::vector<double>& GK16Model::getHdval1mtab() const {
    return Hdval1mtab;
}

const std::vector<double>& GK16Model::getHdval1tab() const {
    return Hdval1tab;
}

const std::vector<double>& GK16Model::getHi1tab() const {
    return Hi1tab;
}

const std::vector<double>& GK16Model::getHs1tab() const {
    return Hs1tab;
}

const std::vector<double>& GK16Model::getHtdval1mtab() const {
    return Htdval1mtab;
}

const std::vector<double>& GK16Model::getHtdval1tab() const {
    return Htdval1tab;
}

const std::vector<double>& GK16Model::getHti1tab() const {
    return Hti1tab;
}

const std::vector<double>& GK16Model::getHtuval1mtab() const {
    return Htuval1mtab;
}

const std::vector<double>& GK16Model::getHtuval1tab() const {
    return Htuval1tab;
}

const std::vector<double>& GK16Model::getHuval1mtab() const {
    return Huval1mtab;
}

const std::vector<double>& GK16Model::getHuval1tab() const {
    return Huval1tab;
}

double GK16Model::getKappaS() const {
    return kappa_s;
}

double GK16Model::getEdval() const {
    return kEdval;
}

double GK16Model::getEgluon() const {
    return kEgluon;
}

double GK16Model::getEsea() const {
    return kEsea;
}

double GK16Model::getEtdval() const {
    return kEtdval;
}

double GK16Model::getEtgluon() const {
    return kEtgluon;
}

double GK16Model::getEtsea() const {
    return kEtsea;
}

double GK16Model::getEtuval() const {
    return kEtuval;
}

double GK16Model::getEuval() const {
    return kEuval;
}

double GK16Model::getHdval() const {
    return kHdval;
}

double GK16Model::getHgluon() const {
    return kHgluon;
}

double GK16Model::getHsea() const {
    return kHsea;
}

double GK16Model::getHtdval() const {
    return kHtdval;
}

double GK16Model::getHtgluon() const {
    return kHtgluon;
}

double GK16Model::getHtsea() const {
    return kHtsea;
}

double GK16Model::getHtuval() const {
    return kHtuval;
}

double GK16Model::getHuval() const {
    return kHuval;
}

std::string GK16Model::toString() const {
