#include "../../../../../include/partons/modules/process/DVCS/BMJ2012DVCSModel.h"
...
const unsigned int BMJ2012DVCSModel::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new BMJ2012DVCSModel("BMJ2012DVCSModel"));

/*--------------------------------------- Constructors ---------------------------------*/

BMJ2012DVCSModel::BMJ2012DVCSModel(const std::string &className) :
...
BMJ2012DVCSModel::~BMJ2012DVCSModel() {
}

BMJ2012DVCSModel::BMJ2012DVCSModel(const BMJ2012DVCSModel& other) :
        DVCSModule(other) {
...
BMJ2012DVCSModel* BMJ2012DVCSModel::clone() const {
    return new BMJ2012DVCSModel(*this);
}

void BMJ2012DVCSModel::initModule() {
...
void BMJ2012DVCSModel::initModule(double beamHelicity, double beamCharge,
...
void BMJ2012DVCSModel::defineAngles(const NumA::Vector3D &targetPolarization) {
...
void BMJ2012DVCSModel::computeFormFactors() {
...
void BMJ2012DVCSModel::computeCFFs() {
...
void BMJ2012DVCSModel::computeFourierCoeffsBH() {
    //TODO Get the value of F1(t) and F2(t) from another module
...
void BMJ2012DVCSModel::computeFourierCoeffsVCS() {
    double C1, C2;
...
void BMJ2012DVCSModel::computeAngularCoeffsInterf() {
    double tQ2 = m_t / m_Q2;
...
void BMJ2012DVCSModel::computeFourierCoeffsInterf() {
// Unpolarized Fourier coeffs
...
std::complex<double> BMJ2012DVCSModel::CFF(GPDType::Type F, int a, int b) {
    unsigned int j;
...
std::complex<double> BMJ2012DVCSModel::C_VCS(unsigned int S, int a1, int b1, int a2,
        int b2) {
...
std::complex<double> BMJ2012DVCSModel::C_I(unsigned int S, int a, int b,
        const std::string& VA) {
...
std::complex<double> BMJ2012DVCSModel::C_I(unsigned int S, unsigned int n, int a,
        int b) {
    unsigned int i;
    if (a == -1) {
        a = 1;
...
std::complex<double> BMJ2012DVCSModel::S_I(unsigned int S, unsigned int n, int a,
        int b) {
    unsigned int i;
    if (a == -1) {
        a = 1;
...
double BMJ2012DVCSModel::SqrAmplBH(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double BMJ2012DVCSModel::SqrAmplVCS(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double BMJ2012DVCSModel::SqrAmplInterf(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double BMJ2012DVCSModel::CrossSectionBH(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
    return 0;
}

double BMJ2012DVCSModel::CrossSectionVCS(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
    return SqrAmplVCS(beamHelicity, beamCharge, targetPolarization)
            * m_phaseSpace;
}

double BMJ2012DVCSModel::CrossSectionInterf(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
    return 0;
}
