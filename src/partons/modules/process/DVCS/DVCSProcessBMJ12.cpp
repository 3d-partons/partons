...
DVCSProcessBMJ12::~DVCSProcessBMJ12() {
}
...
DVCSProcessBMJ12* DVCSProcessBMJ12::clone() const {
    return new DVCSProcessBMJ12(*this);
}
...
void DVCSProcessBMJ12::computeFormFactors() {
...
void DVCSProcessBMJ12::computeCFFs() {
...
void DVCSProcessBMJ12::computeFourierCoeffsBH() {
    //TODO Get the value of F1(t) and F2(t) from another module
...
void DVCSProcessBMJ12::computeFourierCoeffsVCS() {
    double C1, C2;
...
void DVCSProcessBMJ12::computeAngularCoeffsInterf() {
    double tQ2 = m_t / m_Q2;
...
void DVCSProcessBMJ12::computeFourierCoeffsInterf() {
// Unpolarized Fourier coeffs
...
std::complex<double> DVCSProcessBMJ12::CFF(GPDType::Type F, int a, int b) {
    unsigned int j;
...
std::complex<double> DVCSProcessBMJ12::C_I(unsigned int S, int a, int b,
        const std::string& VA) {
...
double DVCSProcessBMJ12::SqrAmplBH(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double DVCSProcessBMJ12::SqrAmplVCS(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double DVCSProcessBMJ12::SqrAmplInterf(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
