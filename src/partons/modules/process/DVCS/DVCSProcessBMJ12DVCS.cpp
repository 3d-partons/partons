...
#include "../../../../../include/partons/modules/process/DVCS/DVCSProcessBMJ12DVCS.h"

// Initialise [class]::classId with a unique name.
const unsigned int DVCSProcessBMJ12DVCS::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new DVCSProcessBMJ12DVCS("DVCSProcessBMJ12DVCS"));

/*--------------------------------------- Constructors ---------------------------------*/

DVCSProcessBMJ12DVCS::DVCSProcessBMJ12DVCS(const std::string &className) :
...
DVCSProcessBMJ12DVCS::~DVCSProcessBMJ12DVCS() {
}

DVCSProcessBMJ12DVCS::DVCSProcessBMJ12DVCS(const DVCSProcessBMJ12DVCS& other) :
        DVCSModule(other) {
...
DVCSProcessBMJ12DVCS* DVCSProcessBMJ12DVCS::clone() const {
    return new DVCSProcessBMJ12DVCS(*this);
}

void DVCSProcessBMJ12DVCS::initModule() {
...
void DVCSProcessBMJ12DVCS::initModule(double beamHelicity, double beamCharge,
...
void DVCSProcessBMJ12DVCS::isModuleWellConfigured() {

    //check mother class
    DVCSModule::isModuleWellConfigured();
}

void DVCSProcessBMJ12DVCS::defineAngles(const NumA::Vector3D &targetPolarization) {
...
void DVCSProcessBMJ12DVCS::computeFormFactors() {
...
void DVCSProcessBMJ12DVCS::computeCFFs() {
...
void DVCSProcessBMJ12DVCS::computeFourierCoeffsBH() {
    //TODO Get the value of F1(t) and F2(t) from another module
...
void DVCSProcessBMJ12DVCS::computeFourierCoeffsVCS() {
    double C1, C2;
...
void DVCSProcessBMJ12DVCS::computeAngularCoeffsInterf() {
    double tQ2 = m_t / m_Q2;
...
void DVCSProcessBMJ12DVCS::computeFourierCoeffsInterf() {
// Unpolarized Fourier coeffs
...
std::complex<double> DVCSProcessBMJ12DVCS::CFF(GPDType::Type F, int a, int b) {
    unsigned int j;
...
std::complex<double> DVCSProcessBMJ12DVCS::C_VCS(unsigned int S, int a1, int b1, int a2,
        int b2) {
...
std::complex<double> DVCSProcessBMJ12DVCS::C_I(unsigned int S, int a, int b,
        const std::string& VA) {
...
std::complex<double> DVCSProcessBMJ12DVCS::C_I(unsigned int S, unsigned int n, int a,
        int b) {
    unsigned int i;
    if (a == -1) {
        a = 1;
...
std::complex<double> DVCSProcessBMJ12DVCS::S_I(unsigned int S, unsigned int n, int a,
        int b) {
    unsigned int i;
    if (a == -1) {
        a = 1;
...
double DVCSProcessBMJ12DVCS::SqrAmplBH(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double DVCSProcessBMJ12DVCS::SqrAmplVCS(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double DVCSProcessBMJ12DVCS::SqrAmplInterf(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double DVCSProcessBMJ12DVCS::CrossSectionBH(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
    return 0;
}

double DVCSProcessBMJ12DVCS::CrossSectionVCS(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
    return SqrAmplVCS(beamHelicity, beamCharge, targetPolarization)
            * m_phaseSpace;
}

double DVCSProcessBMJ12DVCS::CrossSectionInterf(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
    return 0;
}
