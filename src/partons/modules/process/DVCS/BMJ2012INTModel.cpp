#include "../../../../../include/partons/modules/process/DVCS/BMJ2012INTModel.h"
...
const unsigned int BMJ2012INTModel::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new BMJ2012INTModel("BMJ2012INTModel"));

/*--------------------------------------- Constructors ---------------------------------*/

BMJ2012INTModel::BMJ2012INTModel(const std::string &className) :
...
BMJ2012INTModel::~BMJ2012INTModel() {
}

BMJ2012INTModel::BMJ2012INTModel(const BMJ2012INTModel& other) :
        DVCSModule(other) {
...
BMJ2012INTModel* BMJ2012INTModel::clone() const {
    return new BMJ2012INTModel(*this);
}

void BMJ2012INTModel::initModule() {
...
void BMJ2012INTModel::initModule(double beamHelicity, double beamCharge,
...
void BMJ2012INTModel::isModuleWellConfigured() {

    //check mother class
    DVCSModule::isModuleWellConfigured();
}

void BMJ2012INTModel::defineAngles(const NumA::Vector3D &targetPolarization) {
...
void BMJ2012INTModel::computeFormFactors() {
...
void BMJ2012INTModel::computeCFFs() {
...
void BMJ2012INTModel::computeFourierCoeffsBH() {
    //TODO Get the value of F1(t) and F2(t) from another module
...
void BMJ2012INTModel::computeFourierCoeffsVCS() {
    double C1, C2;
...
void BMJ2012INTModel::computeAngularCoeffsInterf() {
    double tQ2 = m_t / m_Q2;
...
void BMJ2012INTModel::computeFourierCoeffsInterf() {
// Unpolarized Fourier coeffs
...
std::complex<double> BMJ2012INTModel::CFF(GPDType::Type F, int a, int b) {
    unsigned int j;
...
std::complex<double> BMJ2012INTModel::C_VCS(unsigned int S, int a1, int b1, int a2,
        int b2) {
...
std::complex<double> BMJ2012INTModel::C_I(unsigned int S, int a, int b,
        const std::string& VA) {
...
std::complex<double> BMJ2012INTModel::C_I(unsigned int S, unsigned int n, int a,
        int b) {
    unsigned int i;
    if (a == -1) {
        a = 1;
...
std::complex<double> BMJ2012INTModel::S_I(unsigned int S, unsigned int n, int a,
        int b) {
    unsigned int i;
    if (a == -1) {
        a = 1;
...
double BMJ2012INTModel::SqrAmplBH(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double BMJ2012INTModel::SqrAmplVCS(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double BMJ2012INTModel::SqrAmplInterf(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double BMJ2012INTModel::CrossSectionBH(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
    return 0;
}

double BMJ2012INTModel::CrossSectionVCS(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
    return 0;
}

double BMJ2012INTModel::CrossSectionInterf(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
