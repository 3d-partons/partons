...
#include "../../../../../include/partons/modules/process/DVCS/DVCSProcessBMJ12BH.h"

// Initialise [class]::classId with a unique name.
const unsigned int DVCSProcessBMJ12BH::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new DVCSProcessBMJ12BH("DVCSProcessBMJ12BH"));

/*--------------------------------------- Constructors ---------------------------------*/

DVCSProcessBMJ12BH::DVCSProcessBMJ12BH(const std::string &className) :
...
DVCSProcessBMJ12BH::~DVCSProcessBMJ12BH() {
}

DVCSProcessBMJ12BH::DVCSProcessBMJ12BH(const DVCSProcessBMJ12BH& other) :
        DVCSModule(other) {
...
DVCSProcessBMJ12BH* DVCSProcessBMJ12BH::clone() const {
    return new DVCSProcessBMJ12BH(*this);
}

void DVCSProcessBMJ12BH::initModule() {
...
void DVCSProcessBMJ12BH::initModule(double beamHelicity, double beamCharge,
...
void DVCSProcessBMJ12BH::isModuleWellConfigured() {

    //check mother class
    DVCSModule::isModuleWellConfigured();
}

void DVCSProcessBMJ12BH::defineAngles(const NumA::Vector3D &targetPolarization) {
...
void DVCSProcessBMJ12BH::computeFormFactors() {
...
void DVCSProcessBMJ12BH::computeCFFs() {
...
void DVCSProcessBMJ12BH::computeFourierCoeffsBH() {
    //TODO Get the value of F1(t) and F2(t) from another module
...
void DVCSProcessBMJ12BH::computeFourierCoeffsVCS() {
    double C1, C2;
...
void DVCSProcessBMJ12BH::computeAngularCoeffsInterf() {
    double tQ2 = m_t / m_Q2;
...
void DVCSProcessBMJ12BH::computeFourierCoeffsInterf() {
// Unpolarized Fourier coeffs
...
std::complex<double> DVCSProcessBMJ12BH::CFF(GPDType::Type F, int a, int b) {
    unsigned int j;
...
std::complex<double> DVCSProcessBMJ12BH::C_VCS(unsigned int S, int a1, int b1,
        int a2, int b2) {
...
std::complex<double> DVCSProcessBMJ12BH::C_I(unsigned int S, int a, int b,
        const std::string& VA) {
...
std::complex<double> DVCSProcessBMJ12BH::C_I(unsigned int S, unsigned int n, int a,
        int b) {
    unsigned int i;
    if (a == -1) {
        a = 1;
...
std::complex<double> DVCSProcessBMJ12BH::S_I(unsigned int S, unsigned int n, int a,
        int b) {
    unsigned int i;
    if (a == -1) {
        a = 1;
...
double DVCSProcessBMJ12BH::SqrAmplBH(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double DVCSProcessBMJ12BH::SqrAmplVCS(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double DVCSProcessBMJ12BH::SqrAmplInterf(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
...
double DVCSProcessBMJ12BH::CrossSectionBH(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
    return SqrAmplBH(beamHelicity, beamCharge, targetPolarization)
            * m_phaseSpace;
}

double DVCSProcessBMJ12BH::CrossSectionVCS(double beamHelicity, double beamCharge,
        NumA::Vector3D targetPolarization) {
    return 0;
}
