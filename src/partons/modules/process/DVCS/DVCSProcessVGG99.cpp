...
DVCSProcessVGG99* DVCSProcessVGG99::clone() const {
    return new DVCSProcessVGG99(*this);
}

DVCSProcessVGG99::~DVCSProcessVGG99() {
}
...
double DVCSProcessVGG99::CrossSectionMechanism(double beamHelicity,
    ...
    if (m_target_polarization == 0.) {
        ...
        if (m_target_polarizationT_x != 0.) {
            ...
            m_proton_spinor_orientation = DVCSProcessVGG99::x;
        ...
        if (m_target_polarizationT_y != 0.) {
            ...
            m_proton_spinor_orientation = DVCSProcessVGG99::y;
        ...
        if (m_target_polarizationL != 0.) {
            ...
            m_proton_spinor_orientation = DVCSProcessVGG99::z;
...
NumA::VectorComplex4D DVCSProcessVGG99::V4ini(std::complex<double> a,
...
NumA::VectorComplex4D DVCSProcessVGG99::spinor_pos(NumA::VectorComplex3D p,
...
NumA::MatrixComplex4D DVCSProcessVGG99::dirac_gamma(int mu) {
...
NumA::MatrixComplex4D DVCSProcessVGG99::dirac_gamma5() {
...
double DVCSProcessVGG99::metric(int mu, int nu) {
...
NumA::VectorComplex3D DVCSProcessVGG99::pauli(double row, double col) {
...
NumA::VectorComplex4D DVCSProcessVGG99::spinor_adj(NumA::VectorComplex4D a) {
...
std::complex<double> DVCSProcessVGG99::spinleft_mat_spinright(
...
NumA::MatrixComplex4D DVCSProcessVGG99::fvec_slash(NumA::VectorComplex4D a) {
...
std::complex<double> DVCSProcessVGG99::V4mul(NumA::VectorComplex4D a,
        NumA::VectorComplex4D b) {
...
std::complex<double> DVCSProcessVGG99::Cinv(std::complex<double> z) {
...
NumA::VectorComplex4D DVCSProcessVGG99::spinor_hel(momentum3 p, double hel) {
...
double DVCSProcessVGG99::polar_angle(NumA::VectorComplex3D t) {
    return acos((t.GetElement(2).real()) / t.Mag());
}

double DVCSProcessVGG99::azimut_angle(NumA::VectorComplex3D t) {
...
NumA::MatrixComplex4D DVCSProcessVGG99::dirac_sigma(int mu, int nu) {
...
NumA::MatrixComplex4D DVCSProcessVGG99::unit_spinor_mat() {
...
double DVCSProcessVGG99::antisymm_epsilon(int ka, int la, int mu, int nu) {
...
NumA::MatrixComplex4D DVCSProcessVGG99::gamma_NN_vertex(int mu,
...
std::complex<double> DVCSProcessVGG99::AmplitudeBH(int mu, double el_hel,
...
std::complex<double> DVCSProcessVGG99::v_compton_t_matrix_hel(double leptcharge,
...
double DVCSProcessVGG99::v_compton_doublepol_sqrampl(double leptcharge,
...
double DVCSProcessVGG99::v_compton_doublepol_cross_inv(double leptcharge,
        int mechanism, double el_hel, double sp_in) {
...
std::complex<double> DVCSProcessVGG99::J_DVCS(int mu, int nu, double sp_in,
        double sp_out) {
...
std::complex<double> DVCSProcessVGG99::AmplitudeDVCS(int mu, double el_hel,
        double sp_in, double sp_out) {
