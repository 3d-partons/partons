...
void GPDSubtractionConstantMMS13::configure(
...
std::string GPDSubtractionConstantMMS13::toString() const {
...
void GPDSubtractionConstantMMS13::initModule() {
	GPDSubtractionConstantModule::initModule();
}

void GPDSubtractionConstantMMS13::isModuleWellConfigured() {
