#include "../../../../../../include/partons/modules/observable/other/elastic/ElasticFFmuGEoverGM.h"
...
const unsigned int ElasticFFmuGEoverGM::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new ElasticFFmuGEoverGM("ElasticFFmuGEoverGM"));

ElasticFFmuGEoverGM::ElasticFFmuGEoverGM(const std::string &className) :
        DVCSObservable(className) {
}

ElasticFFmuGEoverGM::ElasticFFmuGEoverGM(
        const ElasticFFmuGEoverGM& other) :
...
ElasticFFmuGEoverGM* ElasticFFmuGEoverGM::clone() const {
    return new ElasticFFmuGEoverGM(*this);
}

double ElasticFFmuGEoverGM::integrand(double logX, void* params){

    auto parameters = static_cast<ElasticFFmuGEoverGM::Parameters*>(params);
...
PhysicalType<double> ElasticFFmuGEoverGM::computeObservable(
