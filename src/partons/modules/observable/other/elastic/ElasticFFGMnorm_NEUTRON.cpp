#include "../../../../../../include/partons/modules/observable/other/elastic/ElasticFFGMnorm_NEUTRON.h"
...
const unsigned int ElasticFFGMnorm_NEUTRON::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new ElasticFFGMnorm_NEUTRON("ElasticFFGMnorm_NEUTRON"));

ElasticFFGMnorm_NEUTRON::ElasticFFGMnorm_NEUTRON(const std::string &className) :
        DVCSObservable(className) {
}

ElasticFFGMnorm_NEUTRON::ElasticFFGMnorm_NEUTRON(
        const ElasticFFGMnorm_NEUTRON& other) :
...
ElasticFFGMnorm_NEUTRON* ElasticFFGMnorm_NEUTRON::clone() const {
    return new ElasticFFGMnorm_NEUTRON(*this);
}

double ElasticFFGMnorm_NEUTRON::integrand(double logX, void* params){

    auto parameters = static_cast<ElasticFFGMnorm_NEUTRON::Parameters*>(params);
...
PhysicalType<double> ElasticFFGMnorm_NEUTRON::computeObservable(
