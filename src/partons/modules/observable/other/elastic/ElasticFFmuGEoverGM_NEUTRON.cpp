#include "../../../../../../include/partons/modules/observable/other/elastic/ElasticFFmuGEoverGM_NEUTRON.h"
...
const unsigned int ElasticFFmuGEoverGM_NEUTRON::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new ElasticFFmuGEoverGM_NEUTRON("ElasticFFmuGEoverGM_NEUTRON"));

ElasticFFmuGEoverGM_NEUTRON::ElasticFFmuGEoverGM_NEUTRON(const std::string &className) :
        DVCSObservable(className) {
}

ElasticFFmuGEoverGM_NEUTRON::ElasticFFmuGEoverGM_NEUTRON(
        const ElasticFFmuGEoverGM_NEUTRON& other) :
...
ElasticFFmuGEoverGM_NEUTRON* ElasticFFmuGEoverGM_NEUTRON::clone() const {
    return new ElasticFFmuGEoverGM_NEUTRON(*this);
}

double ElasticFFmuGEoverGM_NEUTRON::integrand(double logX, void* params){

    auto parameters = static_cast<ElasticFFmuGEoverGM_NEUTRON::Parameters*>(params);
...
PhysicalType<double> ElasticFFmuGEoverGM_NEUTRON::computeObservable(
