 ...
 *
 */
RunningAlphaStrongStandard::RunningAlphaStrongStandard(const std::string &className) :
...
RunningAlphaStrongStandard::RunningAlphaStrongStandard(const RunningAlphaStrongStandard &other) :
...
RunningAlphaStrongStandard* RunningAlphaStrongStandard::clone() const {
    return new RunningAlphaStrongStandard(*this);
}
...
double RunningAlphaStrongStandard::compute() {
 ...
 *
 */
unsigned int RunningAlphaStrongStandard::GetColourNumber() const {
    return fNc;
}
 ...
 * 
 */
void RunningAlphaStrongStandard::ComputeExpansionCoefficients(unsigned int NFlavour) {
 ...
 *
 */
void RunningAlphaStrongStandard::ComputeLambdaQCD() {
    ...
    fLambdaQCD5 = brentSolver.solve(this, &RunningAlphaStrongStandard::FindLambda,
    ...
    fLambdaQCD4 = brentSolver.solve(this, &RunningAlphaStrongStandard::FindLambda,
    ...
    fLambdaQCD3 = brentSolver.solve(this, &RunningAlphaStrongStandard::FindLambda,
    ...
    fLambdaQCD6 = brentSolver.solve(this, &RunningAlphaStrongStandard::FindLambda,
 ...
 *
 */
void RunningAlphaStrongStandard::Running(double Mu, double Lambda,
 ...
 *
 */
double RunningAlphaStrongStandard::FindLambda(double Lambda,
