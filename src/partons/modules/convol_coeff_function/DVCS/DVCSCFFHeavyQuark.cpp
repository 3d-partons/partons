...
DVCSCFFHeavyQuark::DVCSCFFHeavyQuark(const std::string& className) :
        DVCSCFFStandard(className), m_betas(std::complex<double>(0.0, 0.0)), m_rs(
...
DVCSCFFHeavyQuark* DVCSCFFHeavyQuark::clone() const {
    return new DVCSCFFHeavyQuark(*this);
}
...
std::complex<double> DVCSCFFHeavyQuark::computeUnpolarized() {

    return computeIntegralsMassiveV() + DVCSCFFStandard::computeUnpolarized();
//    return computeIntegralsMassiveV();
}

std::complex<double> DVCSCFFHeavyQuark::computePolarized() {

    return computeIntegralsMassiveA() + DVCSCFFStandard::computePolarized();
//  return computeIntegralsMassiveA();
}

std::complex<double> DVCSCFFHeavyQuark::computeIntegralsMassiveV() {
...
std::complex<double> DVCSCFFHeavyQuark::computeIntegralsMassiveA() {
    double IntegralImaginaryPartMassive = 0.;
    double IntegralRealPartMassive = 0.;
...
std::complex<double> DVCSCFFHeavyQuark::beta(double s, double mq) {
...
std::complex<double> DVCSCFFHeavyQuark::r(double s, double mq) {
...
std::complex<double> DVCSCFFHeavyQuark::MassiveKernelGluonNLOA(double x) {
...
std::complex<double> DVCSCFFHeavyQuark::MassiveKernelGluonNLOV(double x) {
    double z = -m_xi / x;
    double mq = Constant::QUARK_CHARM_MASS;
    double s = -m_Q2 * (z - 1.) / 2. / z;
