...
std::vector<double> DVCSConvolCoeffFunctionModule::test() {
    ...
    convolCoeffFunctionResultToStdVector(compute(DVCSConvolCoeffFunctionKinematic(0.2, -0.1, 4., 4., 4.),
                        getListOfAvailableGPDTypeForComputation()), result);
    convolCoeffFunctionResultToStdVector(compute(DVCSConvolCoeffFunctionKinematic(0.02, -0.5, 16., 16., 16.),
                        getListOfAvailableGPDTypeForComputation()), result);
