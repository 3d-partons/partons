...
#include "../../../../../include/partons/modules/convol_coeff_function/DVCS/DVCSCFFVGG.h"
...
const unsigned int DVCSCFFVGG::classId =
        BaseObjectRegistry::getInstance()->registerBaseObject(
                new DVCSCFFVGG("DVCSCFFVGG"));

const std::string DVCSCFFVGG::PARAMETER_NAME_EPS = "DVCSCFFVGGModel_Eps";

DVCSCFFVGG::DVCSCFFVGG(const std::string& className) :
...
DVCSCFFVGG* DVCSCFFVGG::clone() const {
    return new DVCSCFFVGG(*this);
}

DVCSCFFVGG::~DVCSCFFVGG() {
...
void DVCSCFFVGG::configure(const ElemUtils::Parameters &parameters) {

    if (parameters.isAvailable(DVCSCFFVGG::PARAMETER_NAME_EPS)) {
        eps_cffint = parameters.getLastAvailable().toDouble();
    }
}

DVCSCFFVGG::DVCSCFFVGG(const DVCSCFFVGG& other) :
...
void DVCSCFFVGG::initModule() {
    DVCSConvolCoeffFunctionModule::initModule();
}

void DVCSCFFVGG::isModuleWellConfigured() {
    DVCSConvolCoeffFunctionModule::isModuleWellConfigured();
}

std::complex<double> DVCSCFFVGG::computeUnpolarized() {
...
std::complex<double> DVCSCFFVGG::computePolarized() {
...
double DVCSCFFVGG::intd_vector_part(double x, std::vector<double> par) {
...
double DVCSCFFVGG::intc_vector_part(double x, std::vector<double> par) {
...
std::complex<double> DVCSCFFVGG::calculate_direct() {
...
std::complex<double> DVCSCFFVGG::calculate_crossed() {
