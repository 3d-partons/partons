...
RLVertex::RLVertex(const std::string& className, unsigned int numberOfBasisElements) :
...
std::vector<double> RLVertex::Angular_Integrands(double p2, double q2,
        double k2) const {
...
std::vector<double> RLVertex::Radial_Integrands(double p2, double q2,
    ...
    radial_integrands.at(m_N) = sigmaS_q2;
    return radial_integrands;
}

std::vector<double> RLVertex::Radial_Integrands_deriv(double p2, double q2,
    ...
    radial_integrands_deriv.at(m_N) = dsigmaS_q2;
