...
double RLVertex::H_A_func(unsigned int i, double A_p2, double A_q2, double B_p2,
        double B_q2, double sigmaV_p2, double sigmaV_q2, double sigmaS_p2,
...
double RLVertex::H_M_func(unsigned int i, double A_p2, double A_q2, double B_p2,
        double B_q2, double sigmaV_p2, double sigmaV_q2, double sigmaS_p2,
        double sigmaS_q2) const {
    switch (i) {
    case 9:
...
double RLVertex::H_A_deriv(unsigned int i, double A_p2, double A_q2,
        ...
        double sigmaS_q2, double dsigmaV_p2, double dsigmaV_q2,
        double dsigmaS_p2, double dsigmaS_q2) const {
    switch (i) {
    case 9:
        return dsigmaV_q2;
        break;
...
double RLVertex::H_M_deriv(unsigned int i, double A_p2, double A_q2,
        double dA_p2, double dA_q2, double B_p2, double B_q2, double dB_p2,
        double dB_q2, double sigmaV_p2, double sigmaV_q2, double sigmaS_p2,
        double sigmaS_q2, double dsigmaV_p2, double dsigmaV_q2,
        double dsigmaS_p2, double dsigmaS_q2) const {
