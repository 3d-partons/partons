 ...
 * This class acts as a container to store square values of factorization and renormalization scales. It is used e.g. by ScaleModule class and its derivatives. E.g.
 ...
 Scale scale1 = pQ2Multiplier->compute(Q2);

 Partons::getInstance()->getLoggerManager()->info("example", __func__, ElemUtils::Formatter() << "Factorization scale squared is: " << scale1.getMuF2() << " GeV2");
 Partons::getInstance()->getLoggerManager()->info("example", __func__, ElemUtils::Formatter() << "Renormalization scale squared is: " << scale1.getMuR2() << " GeV2");
 ...
 Scale scale2 = pQ2Multiplier->compute(Q2);

 Partons::getInstance()->getLoggerManager()->info("example", __func__, ElemUtils::Formatter() << "Factorization scale squared is: " << scale2.getMuF2() << " GeV2");
 Partons::getInstance()->getLoggerManager()->info("example", __func__, ElemUtils::Formatter() << "Renormalization scale squared is: " << scale2.getMuR2() << " GeV2");
 \endcode
