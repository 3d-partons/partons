#ifndef DVCSALTINTSINPHIMPHIS_H
#define DVCSALTINTSINPHIMPHIS_H

/**
 * @file DVCSAltIntSinPhiMPhis.h
 ...
 * @brief Longitudinal beam and transverse target asymmetry (interference part).
 *
 * Definition:<br>
 *
 * \f$ \displaystyle
 * A_{LT, Int}^{\sin\left(\phi-\phi_{S}\right)}\left(x_{B}, t, Q^2, \phi\right) =
 * \frac{
 * \left(
 ...
 */
class DVCSAltIntSinPhiMPhis: public DVCSObservable {
...
public:
     ...
     */
    DVCSAltIntSinPhiMPhis(const std::string &className);

    /**
     * Destructor.
     */
    virtual ~DVCSAltIntSinPhiMPhis();

    virtual DVCSAltIntSinPhiMPhis* clone() const;
...
protected:
     ...
     */
    DVCSAltIntSinPhiMPhis(const DVCSAltIntSinPhiMPhis &other);
