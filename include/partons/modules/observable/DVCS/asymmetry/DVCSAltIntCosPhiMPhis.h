#ifndef DVCSALTINTCOSPHIMPHIS_H
#define DVCSALTINTCOSPHIMPHIS_H

/**
 * @file DVCSAltIntCosPhiMPhis.h
 ...
 *
 * \f$ \displaystyle
 * A_{LT, Int}^{\cos\left(\phi-\phi_{S}\right)}\left(x_{B}, t, Q^2, \phi\right) =
 * \frac{
 * \left(
 ...
 */
class DVCSAltIntCosPhiMPhis: public DVCSObservable {
...
public:
     ...
     */
    DVCSAltIntCosPhiMPhis(const std::string &className);
    ...
    virtual DVCSAltIntCosPhiMPhis* clone() const;
...
protected:
     ...
     */
    DVCSAltIntCosPhiMPhis(const DVCSAltIntCosPhiMPhis &other);
