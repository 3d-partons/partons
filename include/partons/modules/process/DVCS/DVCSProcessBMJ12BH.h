#ifndef DVCSPROCESSBMJ12BH_H
#define DVCSPROCESSBMJ12BH_H
...
/**
 * @file DVCSProcessBMJ12BH.h
 * @author Nabil CHOUIKA (SPhN / CEA Saclay)
 * @date 07 October 2015
 * @version 1.0
 *
 * @class DVCSProcessBMJ12BH
 */

class DVCSProcessBMJ12BH: public DVCSModule {
public:
    static const unsigned int classId; ///< Unique ID to automatically register the class in the registry.

    DVCSProcessBMJ12BH(const std::string &className);
    virtual ~DVCSProcessBMJ12BH();

    virtual DVCSProcessBMJ12BH* clone() const;
...
protected:
     ...
     * @param other
     */
    DVCSProcessBMJ12BH(const DVCSProcessBMJ12BH& other);
