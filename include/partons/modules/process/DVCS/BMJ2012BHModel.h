#ifndef BMJ_2012_BH_MODEL_H
#define BMJ_2012_BH_MODEL_H
...
/**
 * @file BMJ2012BHModel.h
 * @author Nabil CHOUIKA (SPhN / CEA Saclay)
 * @date 07 October 2015
 * @version 1.0
 *
 * @class BMJ2012BHModel
 */

class BMJ2012BHModel: public DVCSModule {
public:
    static const unsigned int classId; ///< Unique ID to automatically register the class in the registry.

    BMJ2012BHModel(const std::string &className);
    virtual ~BMJ2012BHModel();

    virtual BMJ2012BHModel* clone() const;
...
protected:
     ...
     * @param other
     */
    BMJ2012BHModel(const BMJ2012BHModel& other);
