#ifndef BMJ_2012_INT_MODEL_H
#define BMJ_2012_INT_MODEL_H
...
/**
 * @file BMJ2012INTModel.h
 * @author Nabil CHOUIKA (SPhN / CEA Saclay)
 * @date 07 October 2015
 * @version 1.0
 *
 * @class BMJ2012INTModel
 */

class BMJ2012INTModel: public DVCSModule {
public:
    static const unsigned int classId; ///< Unique ID to automatically register the class in the registry.

    BMJ2012INTModel(const std::string &className);
    virtual ~BMJ2012INTModel();

    virtual BMJ2012INTModel* clone() const;
...
protected:
     ...
     * @param other
     */
    BMJ2012INTModel(const BMJ2012INTModel& other);
