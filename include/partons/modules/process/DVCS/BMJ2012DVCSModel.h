#ifndef BMJ_2012_DVCS_MODEL_H
#define BMJ_2012_DVCS_MODEL_H
...
class BMJ2012DVCSModel: public DVCSModule {
public:
    static const unsigned int classId; ///< Unique ID to automatically register the class in the registry.

    BMJ2012DVCSModel(const std::string &className);
    virtual ~BMJ2012DVCSModel();

    virtual BMJ2012DVCSModel* clone() const;
...
protected:
     ...
     * @param other
     */
    BMJ2012DVCSModel(const BMJ2012DVCSModel& other);
