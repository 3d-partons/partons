#ifndef DVCSPROCESSBMJ12INT_H
#define DVCSPROCESSBMJ12INT_H
...
/**
 * @file DVCSProcessBMJ12INT.h
 * @author Nabil CHOUIKA (SPhN / CEA Saclay)
 * @date 07 October 2015
 * @version 1.0
 *
 * @class DVCSProcessBMJ12INT
 */

class DVCSProcessBMJ12INT: public DVCSModule {
public:
    static const unsigned int classId; ///< Unique ID to automatically register the class in the registry.

    DVCSProcessBMJ12INT(const std::string &className);
    virtual ~DVCSProcessBMJ12INT();

    virtual DVCSProcessBMJ12INT* clone() const;
...
protected:
     ...
     * @param other
     */
    DVCSProcessBMJ12INT(const DVCSProcessBMJ12INT& other);
