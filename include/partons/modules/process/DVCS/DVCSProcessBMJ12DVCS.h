#ifndef DVCSPROCESSBMJ12DVCS_H
#define DVCSPROCESSBMJ12DVCS_H
...
/**
 * @file DVCSProcessBMJ12DVCS.h
 * @author Nabil CHOUIKA (SPhN / CEA Saclay)
 * @date 07 October 2015
 * @version 1.0
 *
 * @class DVCSProcessBMJ12DVCS
 */

class DVCSProcessBMJ12DVCS: public DVCSModule {
public:
    static const unsigned int classId; ///< Unique ID to automatically register the class in the registry.

    DVCSProcessBMJ12DVCS(const std::string &className);
    virtual ~DVCSProcessBMJ12DVCS();

    virtual DVCSProcessBMJ12DVCS* clone() const;
...
protected:
     ...
     * @param other
     */
    DVCSProcessBMJ12DVCS(const DVCSProcessBMJ12DVCS& other);
