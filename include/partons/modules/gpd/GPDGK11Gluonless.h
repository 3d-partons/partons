#ifndef GPDGK11GLUONLESS_H
#define GPDGK11GLUONLESS_H

/**
 * @file GPDGK11Gluonless.h
 * @author Bryan BERTHOU (CEA Saclay)
 * @author Herve MOUTARDE (CEA Saclay)
 * @date 2014
 * @version 2.0
 *
 * @class GPDGK11Gluonless
 *
...
public:
     ...
     */
    // GK11Gluonless();
    GPDGK11Gluonless(const std::string &className);

    /**
     * Default destructor
     */
    virtual ~GPDGK11Gluonless();

    virtual GPDGK11Gluonless* clone() const;
...
protected:
     ...
     * @param other
     */
    GPDGK11Gluonless(const GPDGK11Gluonless& other);
