#ifndef GPDMPSSW13WITHDTERM_H
#define GPDMPSSW13WITHDTERM_H

/**
 * @file GPDMPSSW13WithDTerm.h
 ...
 */
class GPDMPSSW13WithDTerm: public GPDModule, public MathIntegratorModule {
...
public:
     ...
     */
    GPDMPSSW13WithDTerm(const std::string &className);

    virtual ~GPDMPSSW13WithDTerm();
    virtual GPDMPSSW13WithDTerm* clone() const;
...
protected:
     ...
     */
    GPDMPSSW13WithDTerm(const GPDMPSSW13WithDTerm& other);
