#ifndef GK16_MODELTEST_H
#define GK16_MODELTEST_H

/**
 * @file GK16ModelTest.h
...
class GK16ModelTest: public GPDModule {
public:
     ...
     */
    // GK16ModelTest();
    GK16ModelTest(const std::string &className);
    ...
    virtual GK16ModelTest* clone() const;
...
protected:
     ...
     * @param other
     */
    GK16ModelTest(const GK16ModelTest& other);
