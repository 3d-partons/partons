#ifndef MPSSW13WITHDTERM_MODEL_H
#define MPSSW13WITHDTERM_MODEL_H
 ...
 */
class MPSSW13WithDTermModel: public GPDModule, public MathIntegratorModule {
...
public:
     ...
     */
    MPSSW13WithDTermModel(const std::string &className);
...
protected:
     ...
     */
    MPSSW13WithDTermModel(const MPSSW13WithDTermModel& other);
...
#endif /* MPSSW13WITHDTERM_MODEL_H */
