#ifndef GK11_GLUONLESS_H
#define GK11_GLUONLESS_H

/**
 * @file GK11Gluonless.h
...
class GK11Gluonless: public GPDModule {
public:
     ...
     */
    // GK11Gluonless();
    GK11Gluonless(const std::string &className);

    /**
     * Default destructor
     */
    virtual ~GK11Gluonless();

    virtual GK11Gluonless* clone() const;
...
protected:
     ...
     * @param other
     */
    GK11Gluonless(const GK11Gluonless& other);
