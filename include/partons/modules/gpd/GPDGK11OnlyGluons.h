#ifndef GPDGK11ONLYGLUONS_H
#define GPDGK11ONLYGLUONS_H

/**
 * @file GPDGK11OnlyGluons.h
 * @author Bryan BERTHOU (CEA Saclay)
 * @author Herve MOUTARDE (CEA Saclay)
 * @date 2014
 * @version 2.0
 *
 * @class GPDGK11OnlyGluons
 *
...
class GPDGK11OnlyGluons: public GPDModule {
public:
     ...
     */
    // GK11Model();
    GPDGK11OnlyGluons(const std::string &className);

    /**
     * Default destructor
     */
    virtual ~GPDGK11OnlyGluons();

    virtual GPDGK11OnlyGluons* clone() const;
...
protected:
     ...
     * @param other
     */
    GPDGK11OnlyGluons(const GPDGK11OnlyGluons& other);
