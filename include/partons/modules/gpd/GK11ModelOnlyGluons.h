#ifndef GK11_OG_MODEL_H
#define GK11_OG_MODEL_H

/**
 * @file GKModelOnlyGluons.h
 * @author Bryan BERTHOU (CEA Saclay)
 * @author Herve MOUTARDE (CEA Saclay)
 * @date 2014
 * @version 2.0
 *
 * @class GK11ModelOnlyGluons
 *
...
class GK11ModelOnlyGluons: public GPDModule {
public:
     ...
     */
    // GK11Model();
    GK11ModelOnlyGluons(const std::string &className);

    /**
     * Default destructor
     */
    virtual ~GK11ModelOnlyGluons();

    virtual GK11ModelOnlyGluons* clone() const;
...
protected:
     ...
     * @param other
     */
    GK11ModelOnlyGluons(const GK11ModelOnlyGluons& other);
