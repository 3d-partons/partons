# ObservableService {#usage_obs_4}
 
[TOC]

# generatePlotFile task {#usage_obs_4_lab}
 
## Task name {#usage_obs_4_namexml}

```xml
generatePlotFile
```

## Description {#usage_obs_4_description}
...
## XML example {#usage_obs_4_examplexml} 
